...
public abstract class Class48 {
	...
	static int method247(World var0, World var1, int var2, boolean var3) {
		if (var2 == 1) {
			int var5 = 215269871 * var0.population;
			int var4 = 215269871 * var1.population;
			if (!var3) {
				if (var5 == -1) {
					var5 = 2001;
				}
			...
			return var2 == 2 ? -1854937097 * var0.location - -1854937097 * var1.location
					: (var2 == 3
							? (var0.activity.equals("-") ? (var1.activity.equals("-") ? 0 : (var3 ? -1 : 1))
									: (var1.activity.equals("-") ? (var3 ? 1 : -1)
											: var0.activity.compareTo(var1.activity)))
							: (var2 == 4 ? (var0.method480() ? (var1.method480() ? 0 : 1) : (var1.method480() ? -1 : 0))
									: (var2 == 5
											? (var0.method478() ? (var1.method478() ? 0 : 1)
													: (var1.method478() ? -1 : 0))
											: (var2 == 6
													? (var0.method479() ? (var1.method479() ? 0 : 1)
															: (var1.method479() ? -1 : 0))
													: (var2 == 7
															? (var0.method477() ? (var1.method477() ? 0 : 1)
																	: (var1.method477() ? -1 : 0))
															: var0.id * -145619359 - var1.id * -145619359)))));
		}
	}
}
