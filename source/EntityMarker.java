public final class EntityMarker {
   ...
   static final void method140(Class1 var0) {
      if(Class68.myPlayer.strictX >> 7 == Client.destinationX && Class68.myPlayer.strictY >> 7 == Client.destinationY) {
      ...
      for(int var5 = 0; var5 < var3; var5++) {
         ...
         if(var1 != null && var1.hasConfig() && !var1.hidden) {
            ...
            if((Client.lowMemory && var2 > 50 || var2 > 200) && Class1.aClass1_3 != var0 && var1.anInt1932 == var1.anInt1959) {
               var1.aBool1996 = true;
            }
            ...
            if(var7 >= 0 && var7 < 104 && var8 >= 0 && var8 < 104) {
               if(var1.aModel2001 != null && Client.engineCycle >= var1.anInt1989 && Client.engineCycle < var1.anInt1990) {
                  var1.aBool1996 = false;
                  var1.anInt1997 = NpcType.method802(var1.strictX, var1.strictY, InterfaceNode.floorLevel * -1331355705);
                  InterfaceNode.landscape.method20(InterfaceNode.floorLevel * -1331355705, var1.strictX, var1.strictY, var1.anInt1997, 60, var1, var1.anInt1937 * -2061229533, var4, var1.anInt1994, var1.anInt1995, var1.anInt1987, var1.anInt1985);
               } else {
                  ...
                  var1.anInt1997 = NpcType.method802(var1.strictX, var1.strictY, InterfaceNode.floorLevel * -1331355705);
                  InterfaceNode.landscape.method19(InterfaceNode.floorLevel * -1331355705, var1.strictX, var1.strictY, var1.anInt1997, 60, var1, var1.anInt1937 * -2061229533, var4, var1.aBool1919);
               }
            }
         }
      }
