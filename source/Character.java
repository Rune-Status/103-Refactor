public abstract class Character extends Entity {
      ...
      for(int var7 = 0; var7 < var1 + 0; var7 += 3) {
         ...
         if(var7 < var1 - 1) {
            ...
            if(var7 < var1 - 2) {
               ...
               var2.append(Class88.aCharArray711[(var3 & 0xf) << 2 | var6 >>> 6]).append(Class88.aCharArray711[var6 & 0x3f]);
            } else {
   ...
   static final int calculateTileHeight(int var0, int var1) {
      int var2 = Widget.method494(var0 + '\ub135', var1 + 91923, 4) - 128 + (Widget.method494(var0 + 10294, var1 + '\u93bd', 2) - 128 >> 1) + (Widget.method494(var0, var1, 1) - 128 >> 2);
