				...
				if (!var15.interactable || !IsaacRandom.method68(var15)) {
					...
					if (Client.aWidget2141 == var15) {
						...
						if (Client.aBool2150 && Client.aBool2145) {
							...
							if (var15.height * 1227800423 + var23 > Client.aWidget2142.height * 1227800423
									+ Client.anInt2147) {
								var23 = Client.anInt2147 + Client.aWidget2142.height * 1227800423
					...
					if (!var15.interactable || var22 < var28 && var23 < var29) {
						...
						if (var15.contentType != 0) {
							if (var15.contentType == 1336) {
								if (Client.displayFps) {
									var11 += 15;
									Client.p12_full.method972("Fps:" + Client.fps, var15.width + var10, var11, 16776960,
											-1);
									var11 += 15;
									...
									Client.p12_full.method972("Mem:" + var16 + "k", var15.width + var10, var11, var13,
											-1);
									var11 += 15;
								}
								continue;
							...
							if (var15.contentType == 1337) {
								...
								for (var27 = 0; var27 < 5; var27++) {
									if (Client.aBoolArray2033[var27]) {
										var37 = (int) (Math.random() * (double) (Client.anIntArray2212[var27] * 2 + 1)
								...
								for (var52 = 0; var52 < Client.anInt2082; var52++) {
									...
									while (var46) {
										...
										for (int var71 = 0; var71 < var52; var71++) {
											if (var66 + 2 > Client.anIntArray2085[var71] - Client.anIntArray2086[var71]
													&& var66 - var21 < Client.anIntArray2085[var71] + 2
													&& var72 - var45 < Client.anIntArray2084[var71]
															+ Client.anIntArray2087[var71]
													&& var72 + var45 > Client.anIntArray2084[var71]
															- Client.anIntArray2087[var71]
													&& Client.anIntArray2085[var71]
															- Client.anIntArray2086[var71] < var66) {
									...
									Client.screenY = Client.anIntArray2084[var52];
									Client.screenX = Client.anIntArray2085[var52] = var66;
									...
									if (Client.anInt2133 == 0) {
										...
										if (Client.anIntArray2089[var52] == 1) {
											Class35.b12_full.method964(var711, Client.screenY + var9,
													Client.screenX + var16, var12, 0, Client.anInt2208);
										}

										if (Client.anIntArray2089[var52] == 2) {
											Class35.b12_full.method973(var711, Client.screenY + var9,
													Client.screenX + var16, var12, 0, Client.anInt2208);
										}

										if (Client.anIntArray2089[var52] == 3) {
											Class35.b12_full.method974(var711, Client.screenY + var9,
													Client.screenX + var16, var12, 0, Client.anInt2208,
													150 - Client.anIntArray2132[var52]);
										}
										...
										Class35.b12_full.method982(var711, Client.screenY + var9,
												Client.screenX + var16, 16776960, 0);
									}
								}
						...
						if (var15.type == 0) {
							...
							method272(var0, var15.hash, var22, var23, var28, var29, var10 - var15.insetX,
									var11 - var15.insetY, var18);
							if (var15.children != null) {
								method272(var15.children, var15.hash, var22, var23, var28, var29, var10 - var15.insetX,
										var11 - var15.insetY, var18);
							}
						...
						if (Client.resizable || Client.aBoolArray2137[var18] || Client.anInt2177 > 1) {
							int var481;
							if (var15.type == 0 && !var15.interactable
									&& var15.viewportHeight > var15.height * 1227800423) {
								var9 = var15.width + var10;
								var16 = var15.insetY;
									...
									for (var16 = 0; var16 < var15.anInt1136 * 507570867; var16++) {
										for (var13 = 0; var13 < var15.anInt1135 * 124195285; var13++) {
											...
											if (var15.itemIds[var9] <= 0) {
												...
												if (var31 + 32 > var2 && var31 < var4 && var481 + 32 > var3
														&& var481 < var5
													...
													if (Client.itemSelectionStatus == 1
														...
														var621 = Entity.getItemSprite(var24, var15.itemQuantities[var9],
																2, 0, 2, false);
													} else {
														var621 = Entity.getItemSprite(var24, var15.itemQuantities[var9],
																1, 3153952, 2, false);
														...
														if (SpotAnimType.aWidget1446 == var15
															...
															if (var1 != -1) {
																...
																if (var38 + var481 + 32 > RSGraphics.draw_region_max_y
																	...
																	if (var26 > var69.viewportHeight
																			- var69.height * 1227800423
																			- var69.insetY) {
																		var26 = var69.viewportHeight
																				- var69.height * 1227800423
																				- var69.insetY;
																	}
									...
									if (var15.type == 4) {
										...
										if (var48 == null) {
											...
											if (var15.interactable && var15.itemId != -1) {
												...
												if ((var59.stackable == 1 || var15.itemQuantity != 1)
														&& var15.itemQuantity != -1) {
													var55 = Class48_Sub1.method545(16748608) + var55
															+ Class35.aString393 + " " + 'x'
															+ EnumType.method690(var15.itemQuantity);
												}
											}
											...
											var48.method990(var55, var10, var11, var15.width, var15.height * 1227800423,
													var16, var15.textShadowed ? 0 : -1, var15.anInt1159,
										...
										if (!var15.interactable) {
											...
											if (var15.itemId != -1) {
												var531 = Entity.getItemSprite(var15.itemId, var15.itemQuantity,
														var15.borderThickness, var15.shadowColor, var15.anInt1155,
														false);
											} else {
											...
											if (var531 == null) {
												...
												if (!var15.aBool1144) {
													...
													if (var15.spriteId != 0) {
														var531.method945(var15.width / 2 + var10,
																var15.height * 1227800423 / 2 + var11, var15.spriteId,
																var31);
													} else if (var19 != 0) {
														var531.method953(var10, var11, var15.width,
																var15.height * 1227800423, 256 - (var19 & 0xff));
													} else if (var15.width == var16
															&& var15.height * 1227800423 == var13) {
														var531.method946(var10, var11);
													} else {
														var531.method944(var10, var11, var15.width,
																var15.height * 1227800423);
													}
												} else {
													...
													for (var30 = 0; var30 < var31; var30++) {
														for (var38 = 0; var38 < var481; var38++) {
															if (var15.spriteId != 0) {
																var531.method945(var16 * var30 + var10 + var16 / 2,
																		var13 * var38 + var11 + var13 / 2,
																		var15.spriteId, 4096);
															} else if (var19 != 0) {
																var531.method951(var16 * var30 + var10,
																		var13 * var38 + var11, 256 - (var19 & 0xff));
															} else {
																var531.method946(var16 * var30 + var10,
																		var38 * var13 + var11);
															}
														}
													}
										...
										if (var15.type == 6) {
											...
											if (var15.itemId != -1) {
												...
												var63 = var15.method492(var65, var15.anInt1194, var58,
														Class68.myPlayer.config);
												if (var63 == null && Widget.aBool1128) {
													Class68.method326(var15);
												}
											...
											if (var63 != null) {
												if (!var15.interactable) {
													...
													var63.method998();
													if (var15.aBool1154) {
														var63.method1014(0, var15.rotationZ, var15.rotationY,
																var15.rotationX, var15.anInt1198,
																var481 + var31 + var15.anInt1151,
																var15.anInt1151 + var30, var15.modelZoom);
													} else {
														var63.method1012(0, var15.rotationZ, var15.rotationY,
																var15.rotationX, var15.anInt1198,
																var15.anInt1151 + var481 + var31,
																var15.anInt1151 + var30);
													}
												}
											}
												...
												for (var13 = 0; var13 < var15.anInt1136 * 507570867; var13++) {
													for (var31 = 0; var31 < var15.anInt1135 * 124195285; var31++) {
														if (var15.itemIds[var16] > 0) {
															...
															String var51;
															if (var53.stackable != 1
																	&& var15.itemQuantities[var16] == 1) {
																var51 = Class48_Sub1.method545(16748608) + var53.name
																		+ Class35.aString393;
															} else {
																var51 = Class48_Sub1.method545(16748608) + var53.name
															...
															if (var15.anInt1159 == 0) {
																var48.method980(var51, var38, var24, var15.textColor,
																		var15.textShadowed ? 0 : -1);
															} else if (var15.anInt1159 == 1) {
																var48.method982(var51, var15.width / 2 + var38, var24,
																		var15.textColor, var15.textShadowed ? 0 : -1);
															} else {
																var48.method972(var51, var15.width + var38 - 1, var24,
																		var15.textColor, var15.textShadowed ? 0 : -1);
															}
														}
											...
											if (var15.type == 8 && ScriptEvent.aWidget1437 == var15
