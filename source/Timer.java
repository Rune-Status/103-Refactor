...
public abstract class Timer {
   ...
   static final void decodePlayerFlags(BitBuf buf, int var1, Player var2, int var3) {
      ...
      if((var3 & 0x8) != 0) {
         var5 = buf.getUShort();
         Permission[] var20 = new Permission[]{Permission.PLAYER, Permission.PLAYER_MOD, Permission.JAGEX_MOD, Permission.IRONMAN, Permission.HARDCORE_IRONMAN};
         ...
         if(var2.name != null && var2.config != null) {
            ...
            if(!var11 && Client.anInt2183 == 0 && !var2.hidden) {
               ...
               var2.anInt1927 = 150;
               var2.aBool1946 = var8;
               var2.aBool1923 = Class68.myPlayer != var2 && var21.aBool615 && Client.aString2044 != "" && var16.toLowerCase().indexOf(Client.aString2044) == -1;
               if(var21.aBool611) {
                  var13 = var8 ? 91 : 1;
               } else {
                  var13 = var8 ? 90 : 2;
