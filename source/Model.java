...
public class Model extends Entity {
	...
	public Model method994(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
		...
		int var11 = var2 + this.XYZMag;
		int var16 = var4 - this.XYZMag;
		int var14 = var4 + this.XYZMag;
	...
	void method1002(int var1, int[] var2, int var3, int var4, int var5) {
		...
		if (var1 == 0) {
			...
			for (var10 = 0; var10 < var6; ++var10) {
				...
				if (var19 < this.anIntArrayArray1881.length) {
					int[] var18 = this.anIntArrayArray1881[var19];
			...
			if (var1 == 1) {
					...
					if (var10 < this.anIntArrayArray1881.length) {
						...
						for (var12 = 0; var12 < var14.length; ++var12) {
							...
							if (var17 != 0) {
								...
								this.verticesY[var13] = this.verticesY[var13] * var8
										- this.verticesX[var13] * var16 >> 16;
							...
							if (var11 != 0) {
								...
								this.verticesZ[var13] = this.verticesY[var13] * var16
										+ this.verticesZ[var13] * var8 >> 16;
							...
							if (var7 != 0) {
								...
								this.verticesZ[var13] = this.verticesZ[var13] * var8
										- this.verticesX[var13] * var16 >> 16;
								this.verticesX[var13] = var15;
							}
				...
				if (this.anIntArrayArray1873 != null && this.aByteArray1874 != null) {
					for (var9 = 0; var9 < var6; ++var9) {
						var10 = var2[var9];
		...
		if (this.anInt1897 < 1600) {
			...
			for (var9 = 0; var9 < this.anInt1900; ++var9) {
				if (this.anIntArray1872[var9] != -2) {
					...
					if (var1 && (var5 == -5000 || var10 == -5000 || var12 == -5000)) {
						var4 = yViewportBuffer[var7];
						var13 = yViewportBuffer[var11];
						var14 = yViewportBuffer[var6];
						int var8 = anIntArray1892[var7];
						var15 = anIntArray1892[var11];
						int var16 = anIntArray1892[var6];
						int var17 = anIntArray1893[var7];
						...
						if ((var5 - var10) * (anIntArray1890[var6] - anIntArray1890[var11])
							...
							var4 = (anIntArray1891[var7] + anIntArray1891[var11] + anIntArray1891[var6]) / 3
									+ this.anInt1885;
							anIntArrayArray1876[var4][anIntArray1894[var4]++] = var9;
						}
					}
				}
			}
			...
			if (this.aByteArray1888 == null) {
				for (var9 = this.anInt1897 - 1; var9 >= 0; --var9) {
					...
					if (var7 > 0) {
						var27 = anIntArrayArray1876[var9];

						for (var6 = 0; var6 < var7; ++var6) {
							this.method1011(var27[var6]);
						}
					}
				}
				...
				for (var9 = this.anInt1897 - 1; var9 >= 0; --var9) {
					...
					if (var7 > 0) {
						...
						for (var6 = 0; var6 < var7; ++var6) {
							var5 = var27[var6];
							byte var26 = this.aByteArray1888[var5];
							var12 = anIntArray1896[var26]++;
							anIntArrayArray1901[var26][var12] = var5;
							if (var26 < 10) {
								anIntArray1865[var26] += var9;
							} else if (var26 == 10) {
				...
				int[] var28 = anIntArrayArray1901[10];
				int[] var24 = anIntArray1877;
				if (var5 == var10) {
					var5 = 0;
					var10 = anIntArray1896[11];
					var28 = anIntArrayArray1901[11];
					var24 = anIntArray1898;
				}
				...
				for (var13 = 0; var13 < 10; ++var13) {
					while (var13 == 0 && var6 > var9) {
						this.method1011(var28[var5++]);
						if (var5 == var10 && var28 != anIntArrayArray1901[11]) {
							var5 = 0;
							var10 = anIntArray1896[11];
							var28 = anIntArrayArray1901[11];
							var24 = anIntArray1898;
					...
					int[] var25 = anIntArrayArray1901[var13];

					for (var15 = 0; var15 < var14; ++var15) {
						this.method1011(var25[var15]);
					}
				}
