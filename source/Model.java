public class Model extends Entity {
		...
		if (var15 >= 0 && var11 + 128 >> 7 < var1.length && var16 >= 0 && var14 + 128 >> 7 < var1[0].length) {
			...
			if (var1[var15][var16] == var3 && var1[var11][var16] == var3 && var1[var15][var14] == var3
				...
				if (var6 == 0) {
					...
					for (var12 = 0; var12 < var17.anInt1864; var12++) {
						var13 = (-this.verticesY[var12] << 16) / (this.height * 1812947537);
						if (var13 < var6) {
	...
	public void method998() {
		if (this.anInt1866 != 1) {
			...
			for (int var1 = 0; var1 < this.anInt1864; var1++) {
				int vx = this.verticesX[var1];
				int vy = this.verticesY[var1];
				int vz = this.verticesZ[var1];
				if (-vy > this.height * 1812947537) {
					this.height = -vy * -969595215;
				}

				if (vy > this.anInt1912) {
					this.anInt1912 = vy;
				}

				int var5 = vx * vx + vz * vz;
				if (var5 > this.XYZMag) {
					this.XYZMag = var5;
				}
			}
			...
			this.anInt1885 = (int) (Math.sqrt((double) (this.XYZMag * this.XYZMag
					+ this.height * 1812947537 * this.height * 1812947537)) + 0.99D);
	...
	void draw(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
		...
		if (var13 > 50 && var11 < 3500) {
			...
			int var15 = (var14 - this.XYZMag) * Graphics3D.viewportWidth;
			if (var15 / var13 < Graphics3D.anInt1777) {
				int var16 = (this.XYZMag + var14) * Graphics3D.viewportWidth;
				if (var16 / var13 > Graphics3D.anInt1789) {
					int var17 = var7 * var3 - var10 * var2 >> 16;
					int var18 = this.XYZMag * var2 >> 16;
					int var19 = (var17 + var18) * Graphics3D.viewportWidth;
					if (var19 / var13 > Graphics3D.anInt1797) {
						int var20 = (this.height * 1812947537 * var3 >> 16) + var18;
						int var21 = (var17 - var20) * Graphics3D.viewportWidth;
						if (var21 / var13 < Graphics3D.anInt1783) {
							int var22 = (this.height * 1812947537 * var2 >> 16) + var12;
							boolean var23 = false;
							boolean var24 = false;
							if (var11 - var22 <= 50) {
								var24 = true;
							...
							if (var9 > 0 && aBool1904) {
								...
								var28 = anInt1905 - Graphics3D.centerX;
								var29 = anInt1910 - Graphics3D.centerY;
							...
							var27 = Graphics3D.centerX;
							var28 = Graphics3D.centerY;
							var29 = 0;
							int var30 = 0;
							if (var1 != 0) {
							...
							for (int var31 = 0; var31 < this.anInt1864; var31++) {
								...
								if (var34 >= 50) {
									anIntArray1889[var31] = Graphics3D.viewportWidth * var32 / var34 + var27;
									anIntArray1890[var31] = Graphics3D.viewportWidth * var35 / var34 + var28;
								} else {
	...
	final void method1010(int var1) {
		...
		if (this.aByteArray1874 == null) {
			...
			Graphics3D.alpha = this.aByteArray1874[var1] & 0xff;
		}
		...
		if (var17 >= 50) {
			...
			if (var16 >= 50) {
				...
				anIntArray1899[var15] = (((yViewportBuffer[var13] - var6) * var3 >> 16) + var6)
						* Graphics3D.viewportWidth / 50 + var2;
				anIntArray1882[var15] = (((anIntArray1892[var13] - var7) * var3 >> 16) + var7)
						* Graphics3D.viewportWidth / 50 + var20;
		...
		int var14;
		if (var15 == 3) {
			if (var6 < 0 || var7 < 0 || var8 < 0 || var6 > Graphics3D.rightX || var7 > Graphics3D.rightX
					|| var8 > Graphics3D.rightX) {
			...
			if (this.aShortArray1860 != null && this.aShortArray1860[var1] != -1) {
				...
				if (this.anIntArray1872[var1] == -1) {
					Graphics3D.method912(var3, var4, var5, var6, var7, var8, this.anIntArray1870[var1],
					...
					Graphics3D.method912(var3, var4, var5, var6, var7, var8, xViewportBuffer[0],
				...
				Graphics3D.method917(var3, var4, var5, var6, var7, var8,
						anIntArray1907[this.anIntArray1870[var1]]);
			} else {
				Graphics3D.fillShadedTriangle(var3, var4, var5, var6, var7, var8, xViewportBuffer[0], xViewportBuffer[1],
						xViewportBuffer[2]);
			}
		}
		...
		if (var15 == 4) {
			if (var6 < 0 || var7 < 0 || var8 < 0 || var6 > Graphics3D.rightX || var7 > Graphics3D.rightX
					|| var8 > Graphics3D.rightX || anIntArray1899[3] < 0
					|| anIntArray1899[3] > Graphics3D.rightX) {
				Graphics3D.textX = true;
			}
			...
			if (this.aShortArray1860 != null && this.aShortArray1860[var1] != -1) {
				...
				if (this.anIntArray1872[var1] == -1) {
					Graphics3D.method912(var3, var4, var5, var6, var7, var8, this.anIntArray1870[var1],
							...
							anIntArray1892[var11], anIntArray1893[var9], anIntArray1893[var10], anIntArray1893[var11],
							var21);
					Graphics3D.method912(var3, var5, anIntArray1882[3], var6, var8, anIntArray1899[3],
				...
				Graphics3D.method917(var3, var4, var5, var6, var7, var8, var9);
				Graphics3D.method917(var3, var5, anIntArray1882[3], var6, var8, anIntArray1899[3], var9);
			} else {
				Graphics3D.fillShadedTriangle(var3, var4, var5, var6, var7, var8, xViewportBuffer[0], xViewportBuffer[1],
						xViewportBuffer[2]);
				Graphics3D.fillShadedTriangle(var3, var5, anIntArray1882[3], var6, var8, anIntArray1899[3],
	...
	final void method1011(int var1) {
		if (aBoolArray1902[var1]) {
			...
			Graphics3D.textX = aBoolArray1887[var1];
			if (this.aByteArray1874 == null) {
				Graphics3D.alpha = 0;
			} else {
				Graphics3D.alpha = this.aByteArray1874[var1] & 0xff;
			...
			if (this.aShortArray1860 != null && this.aShortArray1860[var1] != -1) {
				...
				if (this.anIntArray1872[var1] == -1) {
					Graphics3D.method912(anIntArray1890[var8], anIntArray1890[var4], anIntArray1890[var2],
				...
				Graphics3D.method917(anIntArray1890[var8], anIntArray1890[var4], anIntArray1890[var2],
						anIntArray1889[var8], anIntArray1889[var4], anIntArray1889[var2],
						anIntArray1907[this.anIntArray1870[var1]]);
			} else {
				Graphics3D.fillShadedTriangle(anIntArray1890[var8], anIntArray1890[var4], anIntArray1890[var2],
						anIntArray1889[var8], anIntArray1889[var4], anIntArray1889[var2], this.anIntArray1870[var1],
	...
	public final void method1012(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		...
		for (int var19 = 0; var19 < this.anInt1864; var19++) {
			...
			anIntArray1889[var19] = Graphics3D.viewportWidth * var20 / var22 + var8;
			anIntArray1890[var19] = Graphics3D.viewportWidth * var23 / var22 + var9;
			if (this.anInt1878 > 0) {
	...
	public final void method1014(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		for (int var20 = 0; var20 < this.anInt1864; var20++) {
			...
			anIntArray1889[var20] = Graphics3D.viewportWidth * var21 / var8 + var9;
			anIntArray1890[var20] = Graphics3D.viewportWidth * var24 / var8 + var10;
			if (this.anInt1878 > 0) {
				...
				if (this.anIntArray1872[var9] != -2) {
					...
					if (!var1 || var5 != -5000 && var10 != -5000 && var12 != -5000) {
						...
						if ((var5 - var10) * (anIntArray1890[var6] - anIntArray1890[var11])
							...
							if (var5 >= 0 && var10 >= 0 && var12 >= 0 && var5 <= Graphics3D.rightX
									&& var10 <= Graphics3D.rightX && var12 <= Graphics3D.rightX) {
	...
	static {
		anIntArray1907 = Graphics3D.palette;
		SIN_TABLE = Graphics3D.SIN_TABLE;
		COS_TABLE = Graphics3D.COS_TABLE;
		anInt1910 = 0;
		anIntArray1911 = Graphics3D.anIntArray1795;
	}
