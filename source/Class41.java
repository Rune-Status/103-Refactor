	...
	static void method224() {
		...
		if (Class6.username.length() == 0) {
			...
			case 3:
				...
				break;
			case 4:
				GPI.method230("The part of the website you are trying", "to connect to is offline at the moment.",
						"Please try again later.");
				break;
			case 5:
				GPI.method230("Sorry, there was an error trying to", "log you in to this part of the website.",
						"Please try again later.");
				break;
			case 6:
				GPI.method230("", "Error connecting to server.", "");
				break;
			case 7:
				GPI.method230("You must enter a valid login to proceed. For accounts",
