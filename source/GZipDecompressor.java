      ...
      for(int var1 = 0; var1 < Client.anInt2225; var1++) {
         ...
         if(var2 != null && var2.hasConfig() && var2.type.aBool1586 == var0 && var2.type.method803()) {
            ...
            if(var5 >= 0 && var5 < 104 && var3 >= 0 && var3 < 104) {
               ...
               InterfaceNode.landscape.method19(InterfaceNode.floorLevel * -1331355705, var2.strictX, var2.strictY, NpcType.method802(var2.anInt1915 * 64 - 64 + var2.strictX, var2.anInt1915 * 64 - 64 + var2.strictY, InterfaceNode.floorLevel * -1331355705), var2.anInt1915 * 64 - 64 + 60, var2, var2.anInt1937 * -2061229533, var4, var2.aBool1919);
            }
         }
      }
