      ...
      if(var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
         ...
         if(var7 != 0) {
            ...
            if(var1 == 2) {
               ...
               if(var12.anInt1690 != 0) {
                  Client.collisionMaps[var0].method239(var2, var3, var12.sizeX, var12.sizeY, var8, var12.aBool1714);
               }
            }
         ...
         if(var4 >= 0) {
            ...
            if(var6 == 22) {
               if(var81.anInt1698 == -1 && var81.transformIds == null) {
                  ...
                  var20 = new DynamicObject(var4, 22, var5, var14, var2, var3, var81.anInt1698, true, (Entity)null);
               }
               ...
               if(var6 >= 12) {
                  if(var81.anInt1698 == -1 && var81.transformIds == null) {
                     ...
                     var20 = new DynamicObject(var4, var6, var5, var14, var2, var3, var81.anInt1698, true, (Entity)null);
                  }
                  ...
                  if(var81.anInt1698 == -1 && var81.transformIds == null) {
                     ...
                     var20 = new DynamicObject(var4, 0, var5, var14, var2, var3, var81.anInt1698, true, (Entity)null);
                  }

                  var361.addBoundary(var0, var2, var3, var18, (Entity)var20, (Entity)null, Class39.anIntArray434[var5], 0, var22, var23);
                  if(var81.anInt1690 != 0) {
                  ...
                  if(var81.anInt1698 == -1 && var81.transformIds == null) {
                     ...
                     var20 = new DynamicObject(var4, 1, var5, var14, var2, var3, var81.anInt1698, true, (Entity)null);
                  }

                  var361.addBoundary(var0, var2, var3, var18, (Entity)var20, (Entity)null, Class39.anIntArray435[var5], 0, var22, var23);
                  if(var81.anInt1690 != 0) {
                     var211.method242(var2, var3, var6, var5, var81.aBool1714);
                  }
               } else {
                  ...
                  if(var6 == 2) {
                     ...
                     if(var81.anInt1698 == -1 && var81.transformIds == null) {
                        ...
                        var35 = new DynamicObject(var4, 2, var5 + 4, var14, var2, var3, var81.anInt1698, true, (Entity)null);
                        var24 = new DynamicObject(var4, 2, var37, var14, var2, var3, var81.anInt1698, true, (Entity)null);
                     }

                     var361.addBoundary(var0, var2, var3, var18, (Entity)var35, (Entity)var24, Class39.anIntArray434[var5], Class39.anIntArray434[var37], var22, var23);
                     if(var81.anInt1690 != 0) {
                        var211.method242(var2, var3, var6, var5, var81.aBool1714);
                     }
                  } else if(var6 == 3) {
                     if(var81.anInt1698 == -1 && var81.transformIds == null) {
                        ...
                        var20 = new DynamicObject(var4, 3, var5, var14, var2, var3, var81.anInt1698, true, (Entity)null);
                     }
                     ...
                     if(var81.anInt1698 == -1 && var81.transformIds == null) {
                        ...
                        var20 = new DynamicObject(var4, 4, var5, var14, var2, var3, var81.anInt1698, true, (Entity)null);
                     }

                     var361.addBoundaryDecoration(var0, var2, var3, var18, (Entity)var20, (Entity)null, Class39.anIntArray434[var5], 0, 0, 0, var22, var23);
                  } else {
                     int var351;
                     if(var6 == 5) {
                        var37 = 16;
                        ...
                        if(var81.anInt1698 == -1 && var81.transformIds == null) {
                           ...
                           var24 = new DynamicObject(var4, 4, var5, var14, var2, var3, var81.anInt1698, true, (Entity)null);
                        }

                        var361.addBoundaryDecoration(var0, var2, var3, var18, (Entity)var24, (Entity)null, Class39.anIntArray434[var5], 0, Class39.anIntArray427[var5] * var37, Class39.anIntArray436[var5] * var37, var22, var23);
                     } else if(var6 == 6) {
                        var37 = 8;
                        var351 = var361.method53(var0, var2, var3);
                        if(var351 != 0) {
                        ...
                        if(var81.anInt1698 == -1 && var81.transformIds == null) {
                           ...
                           var24 = new DynamicObject(var4, 4, var5 + 4, var14, var2, var3, var81.anInt1698, true, (Entity)null);
                        }

                        var361.addBoundaryDecoration(var0, var2, var3, var18, (Entity)var24, (Entity)null, 256, var5, Class39.anIntArray440[var5] * var37, Class39.anIntArray437[var5] * var37, var22, var23);
                     } else if(var6 == 7) {
                        var351 = var5 + 2 & 0x3;
                        if(var81.anInt1698 == -1 && var81.transformIds == null) {
                           var20 = var81.method861(4, var351 + 4, var17, var13, var18, var19);
                        } else {
                           var20 = new DynamicObject(var4, 4, var351 + 4, var14, var2, var3, var81.anInt1698, true, (Entity)null);
                        }

                        var361.addBoundaryDecoration(var0, var2, var3, var18, (Entity)var20, (Entity)null, 256, var351, 0, 0, var22, var23);
                     } else if(var6 == 8) {
                        var37 = 8;
                        var351 = var361.method53(var0, var2, var3);
                        if(var351 != 0) {
                        ...
                        if(var81.anInt1698 == -1 && var81.transformIds == null) {
                           ...
                           var24 = new DynamicObject(var4, 4, var5 + 4, var14, var2, var3, var81.anInt1698, true, (Entity)null);
                           var26 = new DynamicObject(var4, 4, var25 + 4, var14, var2, var3, var81.anInt1698, true, (Entity)null);
                        }

                        var361.addBoundaryDecoration(var0, var2, var3, var18, (Entity)var24, (Entity)var26, 256, var5, Class39.anIntArray440[var5] * var37, Class39.anIntArray437[var5] * var37, var22, var23);
                     }
                  }
               }
            } else {
               if(var81.anInt1698 == -1 && var81.transformIds == null) {
                  ...
                  var20 = new DynamicObject(var4, 10, var5, var14, var2, var3, var81.anInt1698, true, (Entity)null);
               }

               if(var20 != null) {
                  var361.method18(var0, var2, var3, var18, var121, var27, (Entity)var20, var6 == 11 ? 256 : 0, var22, var23);
               }
