public class RSModel extends Entity {
	...
	public static RSModel method887(AbstractIndex var0, int var1, int var2) {
		byte[] var3 = var0.getFile(var1, var2);
		return var3 == null ? null : new RSModel(var3);
	}
	...
	public RSModel method890(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
		this.method900();
		...
		if (var12 >= 0 && var7 + 128 >> 7 < var1.length && var8 >= 0 && var9 + 128 >> 7 < var1[0].length) {
			...
			if (var1[var12][var8] == var3 && var1[var7][var8] == var3 && var1[var12][var9] == var3
				...
				if (var6 == 0) {
					...
					for (var10 = 0; var10 < var11.vertexCount; var10++) {
						var13 = (-this.vertexY[var10] << 16) / (this.height * 1812947537);
						if (var13 < var6) {
	...
	final int method891(RSModel var1, int var2) {
		int var3 = -1;
	...
	static void method893(RSModel var0, RSModel var1, int var2, int var3, int var4, boolean var5) {
		var0.method900();
		var0.method905();
		var1.method900();
		var1.method905();
	...
	void method900() {
		if (!this.aBool1775) {
			...
			for (int var3 = 0; var3 < this.vertexCount; var3++) {
				...
				if (-var2 > this.height * 1812947537) {
					this.height = -var2 * -969595215;
				}
	...
	static {
		anIntArray1758 = Graphics3D.SIN_TABLE;
		anIntArray1773 = new int[10000];
		anInt1774 = 0;
		anIntArray1776 = Graphics3D.COS_TABLE;
	}
