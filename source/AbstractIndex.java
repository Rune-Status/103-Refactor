...
public abstract class AbstractIndex {
   ...
   public byte[] method375(int var1, int var2, int[] var3) {
      if(var1 >= 0 && var1 < this.anObjectArrayArray705.length && this.anObjectArrayArray705[var1] != null && var2 >= 0 && var2 < this.anObjectArrayArray705[var1].length) {
   ...
   public byte[] method390(int file, int child) {
      if(file >= 0 && file < this.anObjectArrayArray705.length && this.anObjectArrayArray705[file] != null && child >= 0 && child < this.anObjectArrayArray705[file].length) {
