	...
	static File method933(String var0, String var1, int var2) {
		...
		if (Class75.aFile632.exists()) {
			try {
				...
				for (var8 = new ByteBuf(
						(int) var19.length()); var8.position < var8.payload.length; var8.position += var15) {
		...
		if (var4 == null && var2 == 0) {
			label114: for (int var191 = 0; var191 < Class67.historicLocations.length; var191++) {
				for (var15 = 0; var15 < BoundaryDecorationStub.cacheLocations.length; var15++) {
					File var23 = new File(BoundaryDecorationStub.cacheLocations[var15]
							+ Class67.historicLocations[var191] + File.separatorChar + var0 + File.separatorChar);
