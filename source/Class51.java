...
public class Class51 {
	...
	static final void drawDot(int var0, int var1, int var2, int var3, Sprite var4, DualNode_Sub14 var5) {
		if (var4 != null) {
			...
			if (var9 <= 6400) {
				int var8 = Graphics3D.SIN_TABLE[var6];
				int var7 = Graphics3D.COS_TABLE[var6];
				...
				if (var9 > 2500) {
					var4.method954(var5.anInt1647 / 2 + var10 - var4.width / 2,
							var5.anInt1648 / 2 - var11 - var4.height / 2, var0, var1, var5.anInt1647, var5.anInt1648,
							var5.anIntArray1646, var5.anIntArray1645);
				} else {
					var4.method946(var5.anInt1647 / 2 + var10 + var0 - var4.width / 2,
							var5.anInt1648 / 2 + var1 - var11 - var4.height / 2);
				}
			}
		}
