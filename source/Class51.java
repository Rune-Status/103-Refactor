...
public class Class51 {
   ...
   public static String method255(long var0) {
      ...
      return Class53.aStringArray537[var5 - 1] + ", " + var3 / 10 + var3 % 10 + "-" + Class53.aStringArrayArray538[0][var6] + "-" + var2 + " " + var4 / 10 + var4 % 10 + ":" + var7 / 10 + var7 % 10 + ":" + var8 / 10 + var8 % 10 + " GMT";
   }

   static final void drawDot(int var0, int var1, int var2, int var3, Picture var4, DualNode_Sub14 var5) {
      if(var4 != null) {
         int var6 = Client.minimapScale + Client.minimapRotation & 0x7ff;
         int var9 = var2 * var2 + var3 * var3;
         if(var9 <= 6400) {
            int var8 = TexturedGraphic.SIN_TABLE[var6];
            int var7 = TexturedGraphic.COS_TABLE[var6];
            var8 = var8 * 256 / (Client.viewRotation + 256);
            var7 = var7 * 256 / (Client.viewRotation + 256);
            int var10 = var8 * var3 + var2 * var7 >> 16;
            int var11 = var7 * var3 - var8 * var2 >> 16;
            if(var9 > 2500) {
               var4.method954(var5.anInt1647 / 2 + var10 - var4.width / 2, var5.anInt1648 / 2 - var11 - var4.height / 2, var0, var1, var5.anInt1647, var5.anInt1648, var5.anIntArray1646, var5.anIntArray1645);
            } else {
               var4.method946(var5.anInt1647 / 2 + var10 + var0 - var4.width / 2, var5.anInt1648 / 2 + var1 - var11 - var4.height / 2);
            }
         }
      }
