public class Class11 {
   ...
   int method101(int var1, float var2) {
      ...
      if(this.anIntArray215[var1] == 0) {
         ...
         for(var4 = 1; var4 < this.anIntArray215[var1]; var4++) {
            ...
            aFloatArrayArray211[var1][var4 * 2] = aFloatArrayArray211[var1][var4 * 2 - 1] * var6 + aFloatArrayArray211[var1][var4 * 2 - 2] * var7;

            for(int var5 = var4 * 2 - 1; var5 >= 2; --var5) {
               aFloatArrayArray211[var1][var5] += aFloatArrayArray211[var1][var5 - 1] * var6 + aFloatArrayArray211[var1][var5 - 2] * var7;
            }
   ...
   float method102(int var1, int var2, float var3) {
      float var4 = (float)this.anIntArrayArrayArray209[var1][0][var2] + (float)(this.anIntArrayArrayArray209[var1][1][var2] - this.anIntArrayArrayArray209[var1][0][var2]) * var3;
      var4 *= 0.0015258789F;
   ...
   float method105(int var1, int var2, float var3) {
      float var4 = (float)this.anIntArrayArrayArray208[var1][0][var2] + (float)(this.anIntArrayArrayArray208[var1][1][var2] - this.anIntArrayArrayArray208[var1][0][var2]) * var3;
      var4 *= 1.2207031E-4F;
