...
public class Class11 {
	...
	int method101(int var1, float var2) {
		...
		if (this.anIntArray215[var1] == 0) {
			...
			aFloatArrayArray211[var1][0] = -2.0F * var3 * (float) Math.cos((double) this.method105(var1, 0, var2));
			aFloatArrayArray211[var1][1] = var3 * var3;

			int var4;
			for (var4 = 1; var4 < this.anIntArray215[var1]; ++var4) {
				var3 = this.method102(var1, var4, var2);
				float var6 = -2.0F * var3 * (float) Math.cos((double) this.method105(var1, var4, var2));
	...
	float method102(int var1, int var2, float var3) {
		float var4 = (float) this.anIntArrayArrayArray209[var1][0][var2] + var3
	...
	final void method104(ByteBuf var1, Class15 var2) {
		...
		if (var3 != 0) {
			...
			if (var6 != 0 || this.anIntArray210[1] != this.anIntArray210[0]) {
				var2.method126(var1);
			}
		} else {
			int[] var7 = this.anIntArray210;
	...
	float method105(int var1, int var2, float var3) {
		float var4 = (float) this.anIntArrayArrayArray208[var1][0][var2] + var3
