...
public class CacheFile {
   ...
   public void method443(byte[] var1, int var2, int var3) throws IOException {
      try {
         ...
         if(this.aLong815 != -1L && this.position >= this.aLong815 && this.position + (long)var3 <= this.aLong815 + (long)this.anInt807) {
         ...
         if(this.aLong815 != -1L) {
            ...
            if(this.aLong815 + (long)this.anInt807 > var15 && this.aLong815 + (long)this.anInt807 <= (long)var7 + var15) {
               var11 = this.aLong815 + (long)this.anInt807;
            } else if((long)var7 + var15 > this.aLong815 && (long)var7 + var15 <= (long)this.anInt807 + this.aLong815) {
               var11 = (long)var7 + var15;
            }

            if(var9 > -1L && var11 > var9) {
               int var13 = (int)(var11 - var9);
               System.arraycopy(this.writePayload, (int)(var9 - this.aLong815), var1, (int)(var9 - var15) + var2, var13);
   ...
   public void write(byte[] var1, int var2, int var3) throws IOException {
      try {
         ...
         if(this.aLong815 != -1L && (this.position < this.aLong815 || this.position > (long)this.anInt807 + this.aLong815)) {
            this.method449();
         }
         ...
         if(var3 <= this.writePayload.length) {
            ...
            if((long)var3 + this.position > this.aLong809 && this.position + (long)var3 <= (long)this.anInt811 + this.aLong809) {
               var7 = (long)var3 + this.position;
            } else if(this.aLong809 + (long)this.anInt811 > this.position && this.aLong809 + (long)this.anInt811 <= (long)var3 + this.position) {
               var7 = (long)this.anInt811 + this.aLong809;
            }

            if(var101 > -1L && var7 > var101) {
               int var9 = (int)(var7 - var101);
               System.arraycopy(var1, (int)((long)var2 + var101 - this.position), this.readPayload, (int)(var101 - this.aLong809), var9);
            }
   ...
   void method449() throws IOException {
      if(this.aLong815 != -1L) {
         ...
         if((long)this.anInt807 + this.aLong815 > this.aLong809 && (long)this.anInt807 + this.aLong815 <= this.aLong809 + (long)this.anInt811) {
            var3 = (long)this.anInt807 + this.aLong815;
         } else if(this.aLong809 + (long)this.anInt811 > this.aLong815 && (long)this.anInt811 + this.aLong809 <= this.aLong815 + (long)this.anInt807) {
            var3 = (long)this.anInt811 + this.aLong809;
         }

         if(var1 > -1L && var3 > var1) {
            int var5 = (int)(var3 - var1);
            System.arraycopy(this.writePayload, (int)(var1 - this.aLong815), this.readPayload, (int)(var1 - this.aLong809), var5);
         }
