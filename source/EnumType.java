public class EnumType extends DualNode {
	...
	static final String method690(int var0) {
		...
		return var1.length() > 9
				? " " + Class48_Sub1.method545('\uff80') + var1.substring(0, var1.length() - 8) + "M" + " "
						+ Class35.aString389 + var1 + Class35.aString392 + Class35.aString393
				: (var1.length() > 6
						? " " + Class48_Sub1.method545(16777215) + var1.substring(0, var1.length() - 4) + "K" + " "
								+ Class35.aString389 + var1 + Class35.aString392 + Class35.aString393
	...
	static final void method691(InterfaceNode var0, boolean var1) {
		...
		for (WidgetConfig var5 = (WidgetConfig) Client.widgetConfigs
				.method150(); var5 != null; var5 = (WidgetConfig) Client.widgetConfigs.method151()) {
