...
public final class Connection implements Runnable {
   ...
   public static GameType[] gameTypes() {
      return new GameType[]{GameType.OLDSCAPE, GameType.GAME5, GameType.GAME3, GameType.STELLARDAWN, GameType.GAME4, GameType.RUNESCAPE};
   }
      ...
      if(SpotAnimType.aWidget1446 == null && Client.aWidget2141 == null) {
         ...
         if(Client.menuOpen) {
            if(var2 != 1 && (ClanMate.aBool1221 || var2 != 4)) {
               ...
               if(var1 < Class7.menuX - 10 || var1 > Class7.menuX + 10 + Class4.menuWidth || var3 < InvType.menuY - 10 || var3 > Class4.menuHeight + 10 + InvType.menuY) {
            ...
            if((var2 == 1 || !ClanMate.aBool1221 && var2 == 4) && Client.menuItemCount > 0) {
               ...
               if(var1 == 39 || var1 == 40 || var1 == 41 || var1 == 42 || var1 == 43 || var1 == 33 || var1 == 34 || var1 == 35 || var1 == 36 || var1 == 37 || var1 == 38 || var1 == 1005) {
                  ...
                  if(var10 || Class58.method291(Class30.getWidgetConfig(var9))) {
                     if(SpotAnimType.aWidget1446 != null && !Client.aBool2103 && Client.anInt2144 != 1 && !Class39.method217(Client.menuItemCount - 1) && Client.menuItemCount > 0) {
            ...
            if((var2 == 1 || !ClanMate.aBool1221 && var2 == 4) && (Client.anInt2144 == 1 && Client.menuItemCount > 2 || Class39.method217(Client.menuItemCount - 1))) {
               var2 = 2;
            }
