...
public class Class80 {
	...
	void method346(byte[] var1) {
		...
		this.aBuffer662.position = -1841755890;
		...
		int var2;
		int var5;
		for (var5 = 0; var5 < var3; this.aBuffer662.position += var2 * -184175589) {
			int var4 = this.aBuffer662.getInt();
			var2 = this.aBuffer662.getInt();
			if (var4 == 1297379947) {
				this.anIntArray660[var5] = this.aBuffer662.position * 314639891;
				++var5;
			}
		}
	...
	void method349(int var1) {
		this.aBuffer662.position = this.anIntArray658[var1] * -184175589;
	}

	void method350(int var1) {
		this.anIntArray658[var1] = this.aBuffer662.position * 314639891;
	}
	...
	int method351(int var1) {
		...
		if (var5 != 240 && var5 != 247) {
			...
			this.aBuffer662.position += var4 * -184175589;
			return 0;
		}
	}
	...
	void method354(long var1) {
		...
		for (int var3 = 0; var3 < var4; ++var3) {
			...
			this.aBuffer662.position = this.anIntArray660[var3] * -184175589;
			this.method360(var3);
			this.anIntArray658[var3] = this.aBuffer662.position * 314639891;
		}
	...
	int method358(int var1, int var2) {
		int var4;
		if (var2 == 255) {
			int var7 = this.aBuffer662.getUByte();
			...
			var4 = var2;
			if (var3 >= 1) {
				var4 = var2 | this.aBuffer662.getUByte() << 8;
			}
