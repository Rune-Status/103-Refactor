public class Widget extends Node {
   ...
   public Picture method489(boolean var1) {
      ...
      if(var11 == -1) {
         ...
         long var8 = ((long)this.shadowColor << 40) + ((this.flippedVertically ? 1L : 0L) << 38) + (long)var11 + ((long)this.borderThickness << 36) + ((this.flippedHorizontally ? 1L : 0L) << 39);
   ...
   public DualNode_Sub14 method491(boolean var1) {
      ...
      if(var2 == -1) {
         ...
         long var7 = ((long)this.borderThickness << 36) + (long)var2 + ((this.flippedVertically ? 1L : 0L) << 38) + ((this.flippedHorizontally ? 1L : 0L) << 39) + ((long)this.shadowColor << 40);
