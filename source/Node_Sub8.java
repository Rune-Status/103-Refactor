public final class Node_Sub8 extends Node {
   ...
   static final void method546(int var0, int var1) {
      if(TileDecorationStub.chunkBaseX != var0 || Class90.chunkBaseY != var1) {
         ...
         for(Node_Sub8 var211 = (Node_Sub8)Client.aDeque2193.getFront(); var211 != null; var211 = (Node_Sub8)Client.aDeque2193.getNext()) {
            var211.anInt1300 -= offsetX;
            var211.anInt1312 -= offsetY;
            if(var211.anInt1300 < 0 || var211.anInt1312 < 0 || var211.anInt1300 >= 104 || var211.anInt1312 >= 104) {
               var211.unlink();
            }
         }
   ...
   static final void method547(Widget widget, int var1, int var2, int var3) {
      ...
      if(var6 != null) {
         ...
         if(Client.anInt2200 != 2 && Client.anInt2200 != 5) {
            ...
            RuneScript.minimapSprite.method957(var1, var2, var6.anInt1647, var6.anInt1648, var7, var14, var8, Client.viewRotation + 256, var6.anIntArray1646, var6.anIntArray1645);
               ...
               if(var10 >= 104) {
                  ...
                  for(var4 = 0; var4 < var10; var4++) {
                     ...
                     if(var211 != null && var211.hasConfig() && !var211.hidden && Class68.myPlayer != var211) {
                        ...
                        if(Class68.myPlayer.team != 0 && var211.team != 0 && var211.team == Class68.myPlayer.team) {
                           var231 = true;
                        }
                  ...
                  if(Client.anInt2075 != 0 && Client.engineCycle % 20 < 10) {
                     if(Client.anInt2075 == 1 && Client.anInt2021 >= 0 && Client.anInt2021 < Client.npcArray.length) {
                     ...
                     if(Client.anInt2075 == 2) {
                        var4 = Client.hintArrowX * 4 - Node_Sub10.chunkLeftX * 4 + 2 - Class68.myPlayer.strictX / 32;
                        var5 = Client.hintArrowY * 4 - VarClientHub.chunkLeftY * 4 + 2 - Class68.myPlayer.strictY / 32;
                        Class7.method77(var1, var2, var4, var5, Class72.aSpriteArray604[1], var6);
                     }

                     if(Client.anInt2075 == 10 && Client.anInt2158 >= 0 && Client.anInt2158 < Client.playerArray.length) {
                  ...
                  if(!Class68.myPlayer.hidden) {
                     RSGraphics.method793(var6.anInt1647 / 2 + var1 - 1, var6.anInt1648 / 2 + var2 - 1, 3, 3, 16777215);
                  }
                  break;
               }
   ...
   static void method550(int var0) {
      if(Client.anInt2113 != var0) {
         ...
         if(var0 != 5 && var0 != 10) {
            if(var0 == 20) {
               DynamicObject.method1022(LandscapeTile.gameCanvas, Class40.binaryIndex, AnimationSkin.spritesIndex, true, Client.anInt2113 == 11 ? 4 : 0);
            } else if(var0 == 11) {
               DynamicObject.method1022(LandscapeTile.gameCanvas, Class40.binaryIndex, AnimationSkin.spritesIndex, false, 4);
            ...
            DynamicObject.method1022(LandscapeTile.gameCanvas, Class40.binaryIndex, AnimationSkin.spritesIndex, true, 0);
         }
