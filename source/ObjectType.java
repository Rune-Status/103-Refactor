public class ObjectType extends DualNode {
   ...
   void method859(ByteBuf var1, int var2) {
      ...
      if(var2 == 1) {
         ...
         this.anInt1700 = var1.getByte();
      } else if(var2 == 39) {
         this.anInt1701 = var1.getByte() * 25;
   ...
   public final Entity method860(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
      ...
      if(var10 == null) {
         ...
         if(!this.aBool1702) {
            var10 = var9.method902(this.anInt1700 + 64, this.anInt1701 + 768, -50, -10, -50);
         } else {
            var9.aShort1764 = (short)(this.anInt1700 + 64);
            var9.aShort1766 = (short)(this.anInt1701 + 768);
            var9.method905();
            var10 = var9;
         }
      ...
      if(this.clipType >= 0) {
         if(!(var10 instanceof Model)) {
            if(var10 instanceof Entity_Sub1) {
               var10 = ((Entity_Sub1)var10).method890(var3, var4, var5, var6, true, this.clipType);
            }
         } else {
            var10 = ((Model)var10).method994(var3, var4, var5, var6, true, this.clipType);
         }
      }
   ...
   public final Model method861(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
      ...
      if(var8 == null) {
         ...
         var8 = var7.method902(this.anInt1700 + 64, this.anInt1701 + 768, -50, -10, -50);
   ...
   public final Model method862(int var1, int var2, int[][] var3, int var4, int var5, int var6, SequenceType var7, int var8) {
      long var9;
      if(this.anIntArray1689 == null) {
         var9 = (long)((this.id << 10) + var2);
      } else {
      ...
      if(var11 == null) {
         ...
         var11 = var12.method902(this.anInt1700 + 64, this.anInt1701 + 768, -50, -10, -50);
   ...
   final Entity_Sub1 method863(int var1, int var2) {
      ...
      Entity_Sub1 var91 = new Entity_Sub1(var3, var2 == 0 && !var6 && !var10, this.colors == null, this.aShortArray1691 == null, true);
      if(var1 == 4 && var2 > 3) {
         var91.method904(256);
   ...
   public final boolean method866(int var1) {
      if(this.anIntArray1689 != null) {
         for(int var4 = 0; var4 < this.anIntArray1689.length; var4++) {
            if(this.anIntArray1689[var4] == var1) {
   ...
   public final ObjectType transform() {
      ...
      return var1 >= 0 && var1 < this.transformIds.length && this.transformIds[var1] != -1 ? Class37.getObjectType(this.transformIds[var1]) : null;
   }
