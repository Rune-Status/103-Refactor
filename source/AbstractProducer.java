...
public abstract class AbstractProducer {
   ...
   static final void method143(Player var0, int var1, int var2, int var3) {
      if(Class68.myPlayer != var0 && Client.menuItemCount < 400) {
         ...
         if(var0.totalLevel == 0) {
            var5 = var0.aStringArray1986[0] + var0.name + var0.aStringArray1986[1] + Class56.method285(var0.combatLevel, Class68.myPlayer.combatLevel) + " " + Class35.aString389 + "level-" + var0.combatLevel + Class35.aString392 + var0.aStringArray1986[2];
         } else {
            var5 = var0.aStringArray1986[0] + var0.name + var0.aStringArray1986[1] + " " + Class35.aString389 + "skill-" + var0.totalLevel + Class35.aString392 + var0.aStringArray1986[2];
         }

         int var6;
         if(Client.itemSelectionStatus == 1) {
            FriendedPlayer.addMenuRow("Use", Client.selectedItemName + " " + Class35.aString391 + " " + Class48_Sub1.method545(16777215) + var5, 14, var1, var2, var3);
         } else if(Client.spellSelected) {
            if((Class31.currentSpellTargets & 0x8) == 8) {
               FriendedPlayer.addMenuRow(Client.menuActionPrefix, Client.selectedSpellName + " " + Class35.aString391 + " " + Class48_Sub1.method545(16777215) + var5, 15, var1, var2, var3);
            }
         } else {
            for(var6 = 7; var6 >= 0; --var6) {
               if(Client.playerActions[var6] != null) {
                  ...
                  if(Client.playerActions[var6].equalsIgnoreCase("Attack")) {
                     ...
                     if(Client.aClass36_2170 == Class36.aClass36_398 || Client.aClass36_2170 == Class36.aClass36_403 && var0.combatLevel > Class68.myPlayer.combatLevel) {
                        var4 = 2000;
                     }
                  ...
                  FriendedPlayer.addMenuRow(Client.playerActions[var6], Class48_Sub1.method545(16777215) + var5, var8, var1, var2, var3);
               }
            }
         }
   ...
   static void method147(SequenceType var0, int var1, int var2, int var3) {
      if(Client.audioEffectCount < 50 && Client.anInt2205 * 873913835 != 0 && var0.anIntArray1487 != null && var1 < var0.anIntArray1487.length) {
