...
public class ScriptEvent extends Node {
   ...
   static final void method650(int var0, int var1, int var2, int var3, int var4, int var5, Landscape var6, CollisionMap var7) {
      if(!Client.lowMemory || (Class39.renderRules[0][var1][var2] & 0x2) != 0 || (Class39.renderRules[var0][var1][var2] & 0x10) == 0) {
         ...
         if(var8.method865()) {
            ...
            if(var27.anIntArray1273 != null) {
               var27.anInt1274 = var27.anInt1277 + (int)(Math.random() * (double)(var27.anInt1278 - var27.anInt1277));
            }
         }
         ...
         if(var5 == 22) {
            if(!Client.lowMemory || var8.anInt1692 != 0 || var8.anInt1690 == 1 || var8.aBool1711) {
               if(var8.anInt1698 == -1 && var8.transformIds == null) {
                  ...
                  var28 = new DynamicObject(var3, 22, var4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
               }
            ...
            if(var5 != 10 && var5 != 11) {
               if(var5 >= 12) {
                  if(var8.anInt1698 == -1 && var8.transformIds == null) {
                     ...
                     var28 = new DynamicObject(var3, var5, var4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
                  }
                  ...
                  if(var8.anInt1698 == -1 && var8.transformIds == null) {
                     ...
                     var28 = new DynamicObject(var3, 0, var4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
                  }

                  var6.addBoundary(var0, var1, var2, var13, (Entity)var28, (Entity)null, Class39.anIntArray434[var4], 0, var22, var23);
                  if(var4 == 0) {
                     if(var8.clipped) {
                  ...
                  if(var8.anInt1698 == -1 && var8.transformIds == null) {
                     ...
                     var28 = new DynamicObject(var3, 1, var4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
                  }

                  var6.addBoundary(var0, var1, var2, var13, (Entity)var28, (Entity)null, Class39.anIntArray435[var4], 0, var22, var23);
                  if(var8.clipped) {
                     if(var4 == 0) {
                        Class39.aByteArrayArrayArray430[var0][var1][var2 + 1] = 50;
                     } else if(var4 == 1) {
                  ...
                  if(var5 == 2) {
                     ...
                     if(var8.anInt1698 == -1 && var8.transformIds == null) {
                        ...
                        var19 = new DynamicObject(var3, 2, var4 + 4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
                        var30 = new DynamicObject(var3, 2, var20, var0, var1, var2, var8.anInt1698, true, (Entity)null);
                     }

                     var6.addBoundary(var0, var1, var2, var13, (Entity)var19, (Entity)var30, Class39.anIntArray434[var4], Class39.anIntArray434[var20], var22, var23);
                     if(var8.modelClipped) {
                        if(var4 == 0) {
                           Class39.anIntArrayArrayArray433[var0][var1][var2] |= 585;
                           Class39.anIntArrayArrayArray433[var0][var1][var2 + 1] |= 1170;
                     ...
                     if(var8.anInt1698 == -1 && var8.transformIds == null) {
                        ...
                        var28 = new DynamicObject(var3, 3, var4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
                     }
                     ...
                     if(var8.anInt1698 == -1 && var8.transformIds == null) {
                        ...
                        var28 = new DynamicObject(var3, 4, var4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
                     }

                     var6.addBoundaryDecoration(var0, var1, var2, var13, (Entity)var28, (Entity)null, Class39.anIntArray434[var4], 0, 0, 0, var22, var23);
                  } else if(var5 == 5) {
                     var20 = 16;
                     ...
                     if(var8.anInt1698 == -1 && var8.transformIds == null) {
                        ...
                        var30 = new DynamicObject(var3, 4, var4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
                     }

                     var6.addBoundaryDecoration(var0, var1, var2, var13, (Entity)var30, (Entity)null, Class39.anIntArray434[var4], 0, Class39.anIntArray427[var4] * var20, Class39.anIntArray436[var4] * var20, var22, var23);
                  } else if(var5 == 6) {
                     var20 = 8;
                     var10 = var6.method53(var0, var1, var2);
                     if(var10 != 0) {
                     ...
                     if(var8.anInt1698 == -1 && var8.transformIds == null) {
                        ...
                        var30 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
                     }

                     var6.addBoundaryDecoration(var0, var1, var2, var13, (Entity)var30, (Entity)null, 256, var4, Class39.anIntArray440[var4] * var20, Class39.anIntArray437[var4] * var20, var22, var23);
                  } else if(var5 == 7) {
                     var10 = var4 + 2 & 0x3;
                     if(var8.anInt1698 == -1 && var8.transformIds == null) {
                        var28 = var8.method860(4, var10 + 4, var11, var12, var13, var14);
                     } else {
                        var28 = new DynamicObject(var3, 4, var10 + 4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
                     }

                     var6.addBoundaryDecoration(var0, var1, var2, var13, (Entity)var28, (Entity)null, 256, var10, 0, 0, var22, var23);
                  } else if(var5 == 8) {
                     var20 = 8;
                     var10 = var6.method53(var0, var1, var2);
                     if(var10 != 0) {
                     ...
                     if(var8.anInt1698 == -1 && var8.transformIds == null) {
                        ...
                        var30 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
                        var29 = new DynamicObject(var3, 4, var291 + 4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
                     }

                     var6.addBoundaryDecoration(var0, var1, var2, var13, (Entity)var30, (Entity)var29, 256, var4, Class39.anIntArray440[var4] * var20, Class39.anIntArray437[var4] * var20, var22, var23);
                  }
               }
            } else {
               if(var8.anInt1698 == -1 && var8.transformIds == null) {
                  ...
                  var28 = new DynamicObject(var3, 10, var4, var0, var1, var2, var8.anInt1698, true, (Entity)null);
               }

               if(var28 != null && var6.method18(var0, var1, var2, var13, var9, var16, (Entity)var28, var5 == 11 ? 256 : 0, var22, var23) && var8.clipped) {
                  var10 = 15;
                  if(var28 instanceof Model) {
                     var10 = ((Model)var28).method1000() / 4;
                     if(var10 > 30) {
                        var10 = 30;
                     }
                  }
