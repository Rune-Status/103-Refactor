...
public class Class58 {
   ...
   public static String method288(CharSequence var0) {
      ...
      for(int var4 = 0; var4 < var1; var4++) {
         ...
         if((var2 < 97 || var2 > 122) && (var2 < 65 || var2 > 90) && (var2 < 48 || var2 > 57) && var2 != 46 && var2 != 45 && var2 != 42 && var2 != 95) {
            if(var2 == 32) {
               var5.append('+');
            } else {
      ...
      try {
         ...
         if(Client.connectionState == 1) {
            if(KeyFocusListener.socket == null) {
               KeyFocusListener.socket = IsaacRandom.taskManager.createSocket(World.myWorldDomain, ClientSettings.myWorldPort);
            }
            ...
            if(KeyFocusListener.socket.status == 1) {
               Class31.gameConnection = new Connection((Socket)KeyFocusListener.socket.value, IsaacRandom.taskManager);
               KeyFocusListener.socket = null;
         ...
         if(Client.connectionState == 5) {
            int[] var14 = new int[]{(int)(Math.random() * 9.9999999E7D), (int)(Math.random() * 9.9999999E7D), (int)(Math.random() * 9.9999999E7D), (int)(Math.random() * 9.9999999E7D)};
            Client.outBuffer.position = 0;
            ...
            case 0:
               ...
               break;
            case 1:
               Client.outBuffer.putInt(((Integer)AnimationSkin.settings.trustList.get(Integer.valueOf(Class91.bkdrHash(Class6.username)))).intValue());
         ...
         if(Client.connectionState == 8) {
            Client.anInt2180 = 0;
            GPI.method230("You have only just left another world.", "Your profile will be transferred in:", Client.transferTime / 60 + " seconds.");
            ...
            if(Client.connectionState == 9 && Class31.gameConnection.avail() >= 13) {
               ...
               if(var13) {
                  ...
                  if(AnimationSkin.settings.trustList.size() >= 10 && !AnimationSkin.settings.trustList.containsKey(Integer.valueOf(xteaStart))) {
