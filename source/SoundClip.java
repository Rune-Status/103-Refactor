...
public class SoundClip {
      ...
      if(var2 < 10) {
         ...
         for(var10 = 0; var10 < 5; var10++) {
            if(this.anIntArray185[var10] != 0) {
               ...
               anIntArray206[var10] = (int)((double)(this.aClass15_196.anInt236 - this.aClass15_196.anInt233) * 32.768D * Math.pow(1.0057929410678534D, (double)this.anIntArray192[var10]) / var6);
         ...
         for(var10 = 0; var10 < var1; var10++) {
            ...
            for(var3 = 0; var3 < 5; var3++) {
               if(this.anIntArray185[var3] != 0) {
                  ...
                  if(var17 < var1) {
                     anIntArray188[var17] += this.method100(anIntArray191[var3], anIntArray205[var3] * var11 >> 15, this.aClass15_196.anInt238);
         ...
         if(this.aClass15_189 != null) {
            ...
            for(var3 = 0; var3 < var1; var3++) {
               ...
               if(var5) {
                  var4 = this.aClass15_189.anInt233 + ((this.aClass15_189.anInt236 - this.aClass15_189.anInt233) * var17 >> 8);
               } else {
                  var4 = this.aClass15_189.anInt233 + ((this.aClass15_189.anInt236 - this.aClass15_189.anInt233) * var8 >> 8);
               }
            ...
            if(var1 >= var4 + var11) {
               ...
               while(var3 < var17) {
                  ...
                  for(var19 = 0; var19 < var4; var19++) {
                     var8 += (int)((long)anIntArray188[var3 + var4 - 1 - var19] * (long)Class11.anIntArrayArray212[0][var19] >> 16);
                  }

                  for(var19 = 0; var19 < var3; var19++) {
                     var8 -= (int)((long)anIntArray188[var3 - 1 - var19] * (long)Class11.anIntArrayArray212[1][var19] >> 16);
                  }
               ...
               while(true) {
                  ...
                  while(var3 < var17) {
                     ...
                     for(var20 = 0; var20 < var4; var20++) {
                        var19 += (int)((long)anIntArray188[var3 + var4 - 1 - var20] * (long)Class11.anIntArrayArray212[0][var20] >> 16);
                     }

                     for(var20 = 0; var20 < var11; var20++) {
                        var19 -= (int)((long)anIntArray188[var3 - 1 - var20] * (long)Class11.anIntArrayArray212[1][var20] >> 16);
                     }
   ...
   final int method100(int var1, int var2, int var3) {
      return var3 == 1 ? ((var1 & 0x7fff) < 16384 ? var2 : -var2) : (var3 == 2 ? anIntArray202[var1 & 0x7fff] * var2 >> 14 : (var3 == 3 ? ((var1 & 0x7fff) * var2 >> 14) - var2 : (var3 == 4 ? anIntArray201[var1 / 2607 & 0x7fff] * var2 : 0)));
   }
