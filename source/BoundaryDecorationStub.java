public final class BoundaryDecorationStub {
      ...
      while(true) {
         ...
         while(true) {
            ...
            if(var8 > 0 && var11 > 0 && var8 < 103 && var11 < 103) {
               int var19 = var18;
               if((Class39.renderRules[1][var8][var11] & 0x2) == 2) {
                  var19 = var18 - 1;
               }
   ...
   static void method107(GameEngine var0) {
      if(Class74.anInt627 == 1 || !ClanMate.aBool1221 && Class74.anInt627 == 4) {
         int var2 = Class6.anInt132 + 280;
         if(Class74.anInt628 >= var2 && Class74.anInt628 <= var2 + 14 && Class74.anInt629 >= 4 && Class74.anInt629 <= 18) {
            UnderlayType.method704(0, 0);
            return;
         }

         if(Class74.anInt628 >= var2 + 15 && Class74.anInt628 <= var2 + 80 && Class74.anInt629 >= 4 && Class74.anInt629 <= 18) {
            UnderlayType.method704(0, 1);
            return;
         }

         int var3 = Class6.anInt132 + 390;
         if(Class74.anInt628 >= var3 && Class74.anInt628 <= var3 + 14 && Class74.anInt629 >= 4 && Class74.anInt629 <= 18) {
            UnderlayType.method704(1, 0);
            return;
         }

         if(Class74.anInt628 >= var3 + 15 && Class74.anInt628 <= var3 + 80 && Class74.anInt629 >= 4 && Class74.anInt629 <= 18) {
            UnderlayType.method704(1, 1);
            return;
         }

         int var1 = Class6.anInt132 + 500;
         if(Class74.anInt628 >= var1 && Class74.anInt628 <= var1 + 14 && Class74.anInt629 >= 4 && Class74.anInt629 <= 18) {
            UnderlayType.method704(2, 0);
            return;
         }

         if(Class74.anInt628 >= var1 + 15 && Class74.anInt628 <= var1 + 80 && Class74.anInt629 >= 4 && Class74.anInt629 <= 18) {
            UnderlayType.method704(2, 1);
            return;
         }

         int var4 = Class6.anInt132 + 610;
         if(Class74.anInt628 >= var4 && Class74.anInt628 <= var4 + 14 && Class74.anInt629 >= 4 && Class74.anInt629 <= 18) {
            UnderlayType.method704(3, 0);
            return;
         }

         if(Class74.anInt628 >= var4 + 15 && Class74.anInt628 <= var4 + 80 && Class74.anInt629 >= 4 && Class74.anInt629 <= 18) {
            UnderlayType.method704(3, 1);
            return;
         }

         if(Class74.anInt628 >= Class6.anInt132 + 708 && Class74.anInt629 >= 4 && Class74.anInt628 <= Class6.anInt132 + 708 + 50 && Class74.anInt629 <= 20) {
         ...
         if(Class6.anInt144 != -1) {
            World var5 = World.worlds[Class6.anInt144];
   ...
   static void bootClient() {
      ...
      if(Client.bootState == 0) {
         ...
         Class6.bootMessage = "Starting game engine...";
         Class6.anInt122 = 5;
         Client.bootState = 20;
      } else {
         int var1;
         ...
         if(Client.bootState == 20) {
            ...
            Class6.bootMessage = "Prepared visibility map";
            Class6.anInt122 = 10;
            Client.bootState = 30;
            ...
            Class6.bootMessage = "Connecting to update server";
            Class6.anInt122 = 20;
            Client.bootState = 40;
            ...
            if(var0 != 100) {
               if(var0 != 0) {
                  Class6.bootMessage = "Checking for updates - " + var0 + "%";
               }

               Class6.anInt122 = 30;
            } else {
               Class6.bootMessage = "Loaded update list";
               Class6.anInt122 = 30;
               Client.bootState = 45;
            }
         } else {
            ...
            if(Client.bootState == 45) {
               ...
               DualNode_Sub14.aClass8_1644 = ScriptEvent.method651(IsaacRandom.taskManager, LandscapeTile.gameCanvas, 0, 22050);
               ...
               Class30.aClass8_341 = ScriptEvent.method651(IsaacRandom.taskManager, LandscapeTile.gameCanvas, 1, 2048);
               ...
               Class6.bootMessage = "Prepared sound engine";
               Class6.anInt122 = 35;
               Client.bootState = 50;
            } else if(Client.bootState == 50) {
               var0 = 0;
               if(ConsumingImageProducer.p11_full == null) {
                  ConsumingImageProducer.p11_full = ClientSettings.method163(AnimationSkin.spritesIndex, Class2.fontMetricsIndex, "p11_full", "");
               } else {
                  ++var0;
               }
               ...
               if(Class35.b12_full == null) {
                  Class35.b12_full = ClientSettings.method163(AnimationSkin.spritesIndex, Class2.fontMetricsIndex, "b12_full", "");
               } else {
                  ++var0;
               }

               if(var0 < 3) {
                  Class6.bootMessage = "Loading fonts - " + var0 * 100 / 3 + "%";
                  Class6.anInt122 = 40;
               } else {
                  IdentKitType.aNode_Sub10_1467 = new Node_Sub10(true);
                  Class6.bootMessage = "Loaded fonts";
                  Class6.anInt122 = 40;
                  Client.bootState = 60;
               }
               ...
               if(var0 < var1) {
                  Class6.bootMessage = "Loading title screen - " + var0 * 100 / var1 + "%";
                  Class6.anInt122 = 50;
               } else {
                  Class6.bootMessage = "Loaded title screen";
                  Class6.anInt122 = 50;
               ...
               if(!Client.configsIndex.method377()) {
                  Class6.bootMessage = "Loading config - " + Client.configsIndex.method559() + "%";
                  Class6.anInt122 = 60;
               } else {
                  ...
                  Class32.method193(RuneScript.interfaceIndex, Class3.modelsIndex, AnimationSkin.spritesIndex, Class2.fontMetricsIndex);
                  ...
                  Class6.bootMessage = "Loaded config";
                  Class6.anInt122 = 60;
                  Client.bootState = 80;
               }
               ...
               if(Client.bootState == 90) {
                  if(!Class1.texturesIndex.method377()) {
                     Class6.bootMessage = "Loading textures - " + Class1.texturesIndex.method559() + "%";
                     Class6.anInt122 = 90;
                  } else {
                     TextureLoader var161 = new TextureLoader(Class1.texturesIndex, AnimationSkin.spritesIndex, 20, 0.8D, Client.lowMemory ? 64 : 128);
                     TexturedGraphic.setTextureLoader(var161);
                     TexturedGraphic.setBrightness(0.8D);
                     Class6.bootMessage = "Loaded textures";
                     Class6.anInt122 = 90;
                  ...
                  Class6.bootMessage = "Loaded input handler";
                  Class6.anInt122 = 94;
                  Client.bootState = 120;
               } else if(Client.bootState == 120) {
                  if(!Class40.binaryIndex.method385("huffman", "")) {
                     Class6.bootMessage = "Loading wordpack - " + 0 + "%";
                     Class6.anInt122 = 96;
                  } else {
                     Huffman var17 = new Huffman(Class40.binaryIndex.method389("huffman", ""));
                     RuneScript.setHuffman(var17);
                     Class6.bootMessage = "Loaded wordpack";
                     Class6.anInt122 = 96;
                     Client.bootState = 130;
                  }
               } else if(Client.bootState == 130) {
                  if(!RuneScript.interfaceIndex.method377()) {
                     Class6.bootMessage = "Loading interfaces - " + RuneScript.interfaceIndex.method559() * 4 / 5 + "%";
                     Class6.anInt122 = 100;
                  } else if(!InvType.clientScriptsIndex.method377()) {
                     Class6.bootMessage = "Loading interfaces - " + (InvType.clientScriptsIndex.method559() / 6 + 80) + "%";
                     Class6.anInt122 = 100;
                  } else if(!Class2.fontMetricsIndex.method377()) {
                     Class6.bootMessage = "Loading interfaces - " + (Class2.fontMetricsIndex.method559() / 20 + 96) + "%";
                     Class6.anInt122 = 100;
                  } else {
                     Class6.bootMessage = "Loaded interfaces";
                     Class6.anInt122 = 100;
               ...
               if(IgnoredPlayer.aDualNode_Sub13_Sub2Array755 == null) {
                  IgnoredPlayer.aDualNode_Sub13_Sub2Array755 = ObjectType.method868(AnimationSkin.spritesIndex, "mod_icons", "");
               } else {
                  ++var0;
               }

               if(var0 < 13) {
                  Class6.bootMessage = "Loading sprites - " + var0 * 100 / 13 + "%";
                  Class6.anInt122 = 70;
               } else {
                  ...
                  Class6.bootMessage = "Loaded sprites";
                  Class6.anInt122 = 70;
                  Client.bootState = 90;
               }
            }
