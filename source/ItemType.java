...
public class ItemType extends DualNode {
   ...
   public final Entity_Sub1 method809(int var1) {
      ...
      Entity_Sub1 var41 = Entity_Sub1.method887(GZipDecompressor.aClass87_516, this.anInt1630, 0);
      if(var41 == null) {
         return null;
      } else {
   ...
   public final Model method811(int var1) {
      ...
      if(var51 != null) {
         ...
         Entity_Sub1 var61 = Entity_Sub1.method887(GZipDecompressor.aClass87_516, this.anInt1630, 0);
         if(var61 == null) {
            return null;
         } else {
            if(this.anInt1615 != 128 || this.anInt1635 != 128 || this.anInt1636 != 128) {
   ...
   public final Entity_Sub1 method814(boolean var1) {
      ...
      if(var2 == -1) {
         ...
         if(var5 != -1) {
            Entity_Sub1 var9 = Entity_Sub1.method887(GZipDecompressor.aClass87_516, var5, 0);
            if(var4 != -1) {
               Entity_Sub1 var10 = Entity_Sub1.method887(GZipDecompressor.aClass87_516, var4, 0);
               Entity_Sub1[] var8 = new Entity_Sub1[]{var6, var9, var10};
               var6 = new Entity_Sub1(var8, 3);
            } else {
               Entity_Sub1[] var101 = new Entity_Sub1[]{var6, var9};
               var6 = new Entity_Sub1(var101, 2);
            }
         }
   ...
   public final Entity_Sub1 method818(boolean var1) {
      ...
      if(var2 == -1) {
         ...
         if(var4 != -1) {
            ...
            Entity_Sub1[] var6 = new Entity_Sub1[]{var5, var7};
