...
public abstract class GameEngine extends Applet implements Runnable, FocusListener, WindowListener {
   ...
   public void run() {
      try {
         ...
         while(aLong1972 == 0L || AnimationSkin.currentTimeMs() < aLong1972) {
            Node_Sub8.anInt1301 = Class90.aClass66_721.method322(anInt1974, anInt1973);
   ...
   public final synchronized void paint(Graphics var1) {
      if(shell == this && !aBool1970) {
         aBool1979 = true;
         if(TaskManager.javaVersion != null && TaskManager.javaVersion.startsWith("1.5") && AnimationSkin.currentTimeMs() - aLong1984 > 1000L) {
