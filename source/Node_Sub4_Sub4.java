public class Node_Sub4_Sub4 extends Node_Sub4 {
	...
	int method835(Node_Sub14 var1) {
		...
		if (var2.anInt773 > 0) {
			var3 = (int) ((double) var3
					* Math.pow(0.5D, (double) var1.anInt1396 * 1.953125E-5D * (double) var2.anInt773) + 0.5D);
		}
		...
		if (var4 != null) {
			...
			if ((this.anIntArray1667[var1] & 0x2) != 0) {
				for (Node_Sub14 var5 = (Node_Sub14) this.aNode_Sub4_Sub3_1681.aDeque1652
						.getFront(); var5 != null; var5 = (Node_Sub14) this.aNode_Sub4_Sub3_1681.aDeque1652.getNext()) {
	...
	void method841(int var1) {
		if ((this.anIntArray1667[var1] & 0x2) != 0) {
			for (Node_Sub14 var2 = (Node_Sub14) this.aNode_Sub4_Sub3_1681.aDeque1652
					.getFront(); var2 != null; var2 = (Node_Sub14) this.aNode_Sub4_Sub3_1681.aDeque1652.getNext()) {
				if (var2.anInt1379 == var1 && this.aNode_Sub14ArrayArray1665[var1][var2.anInt1391] == null
						&& var2.anInt1376 < 0) {
					var2.anInt1376 = 0;
				}
			}
	...
	int method845(Node_Sub14 var1) {
		...
		var4 = (int) ((double) (var1.aNode_Sub2_Sub1_1378.anInt1542 * 256)
				* Math.pow(2.0D, (double) var2 * 3.255208333333333E-4D) / (double) AbstractSoundSystem.sampleRate
				+ 0.5D);
	...
	int method846(Node_Sub14 var1) {
		...
		return var2 >= 8192 ? 16384 - ((16384 - var2) * (128 - var1.anInt1383) + 32 >> 6)
				: var1.anInt1383 * var2 + 32 >> 6;
	}
	...
	protected synchronized void method530(int[] var1, int var2, int var3) {
		if (this.aClass80_1675.method357()) {
			...
			do {
				...
				int var4 = (int) (((long) var5 + (this.aLong1680 - this.aLong1658 * -3956681610824063275L) - 1L)
						/ (long) var5);
	...
	protected synchronized void method528(int var1) {
		if (this.aClass80_1675.method357()) {
			...
			do {
				...
				int var2 = (int) (((long) var5 + (this.aLong1680 - this.aLong1658 * -3956681610824063275L) - 1L)
						/ (long) var5);
	...
	boolean method848(Node_Sub14 var1, int[] var2, int var3, int var4) {
		...
		if (var1.anInt1376 < 0 || var1.aNode_Sub4_Sub2_1394 != null && !var1.aNode_Sub4_Sub2_1394.method750()) {
			...
			if (var8 > 0) {
				var8 -= (int) (Math.pow(2.0D, (double) this.anIntArray1679[var1.anInt1379] * 4.921259842519685E-4D)
						* 16.0D + 0.5D);
				if (var8 < 0) {
					var8 = 0;
				}
			...
			double var5 = (double) ((var1.anInt1386 * -1856256381 * var1.anInt1385 * 267719497 >> 12)
					+ (var1.anInt1391 - 60 << 8)) * 5.086263020833333E-6D;
			if (var7.anInt773 > 0) {
				if (var7.anInt776 > 0) {
			...
			if (var7.aByteArray772 != null) {
				...
				while (var1.anInt1389 < var7.aByteArray772.length - 2
						&& var1.anInt1390 > (var7.aByteArray772[var1.anInt1389 + 2] & 0xff) << 8) {
					var1.anInt1389 += 2;
				}
			...
			if (var1.anInt1376 >= 0 && var7.aByteArray778 != null && (this.anIntArray1667[var1.anInt1379] & 0x1) == 0
					&& (var1.anInt1380 < 0 || this.aNode_Sub14ArrayArray1673[var1.anInt1379][var1.anInt1380] != var1)) {
				if (var7.anInt775 > 0) {
				...
				while (var1.anInt1377 < var7.aByteArray778.length - 2
						&& var1.anInt1376 > (var7.aByteArray778[var1.anInt1377 + 2] & 0xff) << 8) {
					var1.anInt1377 += 2;
				}
		...
		if (var81 != null) {
			...
			if (var91 != null) {
				...
				if (this.anIntArray1663[var1] == 0) {
					var7.aNode_Sub4_Sub2_1394 = Node_Sub4_Sub2.method737(var91, this.method845(var7),
							this.method835(var7), this.method846(var7));
				} else {
					var7.aNode_Sub4_Sub2_1394 = Node_Sub4_Sub2.method737(var91, this.method845(var7), 0,
							this.method846(var7));
