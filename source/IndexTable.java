   ...
   public byte[] method302(int var1) {
      ...
      synchronized(var2) {
         ...
         try {
            ...
            int var15 = (aByteArray571[2] & 0xff) + ((aByteArray571[1] & 0xff) << 8) + ((aByteArray571[0] & 0xff) << 16);
            int var4 = (aByteArray571[5] & 0xff) + ((aByteArray571[4] & 0xff) << 8) + ((aByteArray571[3] & 0xff) << 16);
            ...
            if(var4 > 0 && (long)var4 <= this.dataFile.method450() / 520L) {
               ...
               for(int var10000 = 0; var6 < var15; var10000++) {
                  ...
                  int var11 = ((aByteArray571[5] & 0xff) << 8) + ((aByteArray571[4] & 0xff) << 16) + (aByteArray571[6] & 0xff);
      ...
      synchronized(var5) {
         try {
            ...
            if(var4) {
               ...
               this.indexFile.seek((long)(var1 * 6));
               this.indexFile.method443(aByteArray571, 0, 6);
               var15 = (aByteArray571[5] & 0xff) + ((aByteArray571[4] & 0xff) << 8) + ((aByteArray571[3] & 0xff) << 16);
               ...
               if(var7 < var3) {
                  label130: {
                     ...
                     if(var4) {
                        ...
                        var9 = (aByteArray571[6] & 0xff) + ((aByteArray571[4] & 0xff) << 16) + ((aByteArray571[5] & 0xff) << 8);
                        int var12 = aByteArray571[7] & 0xff;
