   ...
   static final void method329(Character var0, int var1) {
      ...
      if(var0.anInt1928 > Client.engineCycle) {
         ...
         if(var0.anInt1947 >= Client.engineCycle) {
            if(var0.anInt1947 == Client.engineCycle || var0.animation == -1 || var0.anInt1936 != 0 || var0.anInt1935 + 1 > Node_Sub6.getSequenceType(var0.animation).anIntArray1481[var0.anInt1934]) {
            ...
            if(var0.queueSize == 0) {
               ...
               label332: {
                  ...
                  if(var6 - var2 <= 256 && var6 - var2 >= -256 && var7 - var13 <= 256 && var7 - var13 >= -256) {
                     ...
                     if(var10) {
                        if(var0.anInt1953 * -2061229533 != var0.anInt1937 * -2061229533 && var0.targetIndex == -1 && var0.orientation * -2031663291 != 0) {
                           var8 = 2;
                        }
      ...
      if(Class68.myPlayer == var0 && (var0.strictX < 1536 || var0.strictY < 1536 || var0.strictX >= 11776 || var0.strictY >= 11776)) {
         var0.animation = -1;
         var0.anInt1938 = -1;
         var0.anInt1928 = 0;
         var0.anInt1947 = 0;
      ...
      if(var0.anInt1932 != -1) {
         ...
         if(var11 != null && var11.anIntArray1474 != null) {
            ++var0.anInt1933;
            if(var0.anInt1914 < var11.anIntArray1474.length && var0.anInt1933 > var11.anIntArray1481[var0.anInt1914]) {
               var0.anInt1933 = 1;
               ++var0.anInt1914;
      ...
      if(var0.anInt1938 != -1 && Client.engineCycle >= var0.anInt1941) {
         ...
         if(var2 != -1) {
            ...
            if(var121 != null && var121.anIntArray1474 != null) {
               ++var0.anInt1940;
               if(var0.anInt1925 < var121.anIntArray1474.length && var0.anInt1940 > var121.anIntArray1481[var0.anInt1925]) {
                  var0.anInt1940 = 1;
                  ++var0.anInt1925;
                  AbstractProducer.method147(var121, var0.anInt1925, var0.strictX, var0.strictY);
               }

               if(var0.anInt1925 >= var121.anIntArray1474.length && (var0.anInt1925 < 0 || var0.anInt1925 >= var121.anIntArray1474.length)) {
                  var0.anInt1938 = -1;
               }
            } else {
               var0.anInt1938 = -1;
      ...
      if(var0.animation != -1 && var0.anInt1936 <= 1) {
         var11 = Node_Sub6.getSequenceType(var0.animation);
         if(var11.anInt1484 == 1 && var0.anInt1957 > 0 && var0.anInt1928 <= Client.engineCycle && var0.anInt1947 < Client.engineCycle) {
            var0.anInt1936 = 1;
            return;
         }
      }
      ...
      if(var0.animation != -1 && var0.anInt1936 == 0) {
         ...
         if(var11 != null && var11.anIntArray1474 != null) {
            ++var0.anInt1935;
            if(var0.anInt1934 < var11.anIntArray1474.length && var0.anInt1935 > var11.anIntArray1481[var0.anInt1934]) {
               var0.anInt1935 = 1;
               ++var0.anInt1934;
