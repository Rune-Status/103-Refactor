public class Class48_Sub1 extends Class48 {
   ...
   static final int method544() {
      if(AnimationSkin.settings.hideRoofs) {
         ...
         return var0 - FriendedPlayer.cameraZ < 800 && (Class39.renderRules[InterfaceNode.floorLevel * -1331355705][Projectile.cameraX >> 7][Class72.cameraY >> 7] & 0x4) != 0 ? InterfaceNode.floorLevel * -1331355705 : 3;
      }
   }
