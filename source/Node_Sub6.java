...
public final class Node_Sub6 extends Node {
	...
	public static void initialize(String var0, String var1, int var2, int var3) throws IOException {
		...
		Class67.historicLocations = new String[] { ".jagex_cache_" + Class75.buildOrdinal,
				".file_store_" + Class75.buildOrdinal };
		int var4 = 0;

		int var15;
		File var17;
		label116: while (var4 < 4) {
		...
		try {
			...
			if (var131.exists()) {
				...
				label98: for (var15 = 0; var15 < Class67.historicLocations.length; var15++) {
					for (var14 = 0; var14 < BoundaryDecorationStub.cacheLocations.length; var14++) {
						var17 = new File(BoundaryDecorationStub.cacheLocations[var14] + Class67.historicLocations[var15]
