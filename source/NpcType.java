public class NpcType extends DualNode {
   ...
   public final Model method799(SequenceType var1, int var2, SequenceType var3, int var4) {
      if(this.transformIds != null) {
         ...
         if(var5 == null) {
            ...
            Entity_Sub1[] var121 = new Entity_Sub1[this.anIntArray1581.length];

            int var6;
            for(var6 = 0; var6 < this.anIntArray1581.length; var6++) {
               var121[var6] = Entity_Sub1.method887(aClass87_1596, this.anIntArray1581[var6], 0);
            }
            ...
            if(var121.length == 1) {
               ...
               var11 = new Entity_Sub1(var121, var121.length);
            }
   ...
   public final Entity_Sub1 method800() {
      if(this.transformIds != null) {
         ...
         if(var2) {
            ...
            Entity_Sub1[] var61 = new Entity_Sub1[this.anIntArray1582.length];

            for(int var6 = 0; var6 < this.anIntArray1582.length; var6++) {
               var61[var6] = Entity_Sub1.method887(aClass87_1596, this.anIntArray1582[var6], 0);
            }
            ...
            if(var61.length == 1) {
               ...
               var71 = new Entity_Sub1(var61, var61.length);
            }
   ...
   public final NpcType transform() {
      ...
      return var1 >= 0 && var1 < this.transformIds.length && this.transformIds[var1] != -1 ? VarPlayerType.getNpcType(this.transformIds[var1]) : null;
   }
   ...
   static final int method802(int var0, int var1, int var2) {
      ...
      if(var3 >= 0 && var4 >= 0 && var3 <= 103 && var4 <= 103) {
         ...
         int var7 = var0 & 0x7f;
         int var5 = var1 & 0x7f;
         int var9 = Class39.tileHeights[var6][var3][var4] * (128 - var7) + Class39.tileHeights[var6][var3 + 1][var4] * var7 >> 7;
         int var8 = Class39.tileHeights[var6][var3 + 1][var4 + 1] * var7 + Class39.tileHeights[var6][var3][var4 + 1] * (128 - var7) >> 7;
   ...
   static int method804(int var0, int var1) {
      ...
      return Class1.currentRequest != null && Class1.currentRequest.key == var2 ? Class81.currentBuffer.position * 99 / (Class81.currentBuffer.payload.length - Class1.currentRequest.padding) + 1 : 0;
   }

   static final void method805(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      Node_Sub8 var9 = null;

      for(Node_Sub8 var10 = (Node_Sub8)Client.aDeque2193.getFront(); var10 != null; var10 = (Node_Sub8)Client.aDeque2193.getNext()) {
         if(var10.anInt1302 == var0 && var10.anInt1300 == var1 && var10.anInt1312 == var2 && var10.anInt1303 == var3) {
            var9 = var10;
            break;
         }
      }
