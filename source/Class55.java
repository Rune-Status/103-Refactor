		...
		while (true) {
			while (var23) {
				...
				for (var32 = 0; var32 < var39; var32++) {
					...
					method282(var0.anIntArrayArray497[var32], var0.anIntArrayArray498[var32],
							var0.anIntArrayArray499[var32], var0.aByteArrayArray496[var32], var33, var43, var54);
						...
						if (var50 != 0 && var50 != 1) {
							...
							if (var36 < 16) {
								...
								if (var0.anIntArray493[0] == 0) {
									...
									for (var51 = 15; var51 >= 0; --var51) {
										for (var53 = 15; var53 >= 0; --var53) {
											var0.aByteArray489[var52] = var0.aByteArray489[var0.anIntArray493[var51]
													+ var53];
											--var52;
										}
