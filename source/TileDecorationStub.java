public final class TileDecorationStub {
	...
	static final void method462(int var0, int var1, int var2, int var3) {
		...
		for (var7 = 0; var7 < Rasterizer.onCursorCount; var7++) {
			...
			if (var8 != var4) {
				var4 = var8;
				if (var16 == 2 && InterfaceNode.landscape.method34(InterfaceNode.floorLevel * -1331355705, var21, var10,
						var8) >= 0) {
							...
							FriendedPlayer
									.addMenuRow(Client.menuActionPrefix,
											Client.selectedSpellName + " " + Class35.aString391 + " "
													+ Class48_Sub1.method545('\uffff') + var15.name,
											2, var8, var21, var10);
						}
					} else {
						...
						if (var18 != null) {
							for (int var19 = 4; var19 >= 0; --var19) {
								if (var18[var19] != null) {
									...
									FriendedPlayer.addMenuRow(var18[var19],
											Class48_Sub1.method545('\uffff') + var15.name, var25, var8, var21, var10);
								}
							}
						}

						FriendedPlayer.addMenuRow("Examine", Class48_Sub1.method545('\uffff') + var15.name, 1002,
								var15.id << 14, var21, var10);
					}
				}
				...
				if (var16 == 0) {
					...
					if ((var271.strictX & 0x7f) == 64 && (var271.strictY & 0x7f) == 64) {
						...
						for (var27 = 0; var27 < var281; var27++) {
							var241 = Client.playerArray[var261[var27]];
							if (var241 != null && var271 != var241 && var241.strictX == var271.strictX
									&& var241.strictY == var271.strictY) {
								AbstractProducer.method143(var241, var261[var27], var21, var10);
							}
						}
					}
							...
							if (Client.itemSelectionStatus == 1) {
								...
								if ((Class31.currentSpellTargets & 0x1) == 1) {
									FriendedPlayer.addMenuRow(Client.menuActionPrefix,
											Client.selectedSpellName + " " + Class35.aString391 + " "
													+ Class48_Sub1.method545(16748608) + var20.name,
											17, var26.anInt1842, var21, var10);
								}
							} else {
								...
								for (int var28 = 4; var28 >= 0; --var28) {
									if (var29 != null && var29[var28] != null) {
										...
										FriendedPlayer.addMenuRow(var29[var28],
												Class48_Sub1.method545(16748608) + var20.name, var14, var26.anInt1842,
												var21, var10);
									} else if (var28 == 2) {
										FriendedPlayer.addMenuRow("Take", Class48_Sub1.method545(16748608) + var20.name,
												20, var26.anInt1842, var21, var10);
									}
								}

								FriendedPlayer.addMenuRow("Examine", Class48_Sub1.method545(16748608) + var20.name,
										1004, var26.anInt1842, var21, var10);
							}
						}
					}
				}
