...
public final class Npc extends Character {
	...
	final void method1024(int var1, byte var2) {
		...
		if (-922607859 * this.animation != -1
				&& Node_Sub6.method540(this.animation * -922607859, -990032604).anInt1469 * -1099577343 == 1) {
	...
	protected final Model method654(byte var1) {
		if (this.definition == null) {
			...
			DualNode_Sub3 var3 = -922607859 * this.animation != -1 && 1301453073 * this.anInt1936 == 0
					? Node_Sub6.method540(-922607859 * this.animation, -1057804674) : null;
			DualNode_Sub3 var4 = 57983255 * this.anInt1932 != -1
					&& (370127001 * this.anInt1959 != this.anInt1932 * 57983255 || var3 == null)
							? Node_Sub6.method540(57983255 * this.anInt1932, -411318777) : null;
			...
			if (var2 == null) {
				...
				if (1631645159 * this.anInt1938 != -1 && this.anInt1925 * -1255206495 != -1) {
					Model var5 = Class96_Sub1.method499(1631645159 * this.anInt1938, (byte) 1)
	...
	final void method1025(int var1, int var2, boolean var3) {
		if (this.animation * -922607859 != -1
				&& Node_Sub6.method540(this.animation * -922607859, -42968786).anInt1469 * -1099577343 == 1) {
			this.animation = 1587034171;
		}
