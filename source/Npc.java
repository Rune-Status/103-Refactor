public final class Npc extends Character {
   ...
   protected final Model method654(byte var1) {
      if(this.type == null) {
         ...
         SequenceType var3 = this.animation != -1 && this.anInt1936 == 0 ? Node_Sub6.getSequenceType(this.animation) : null;
         SequenceType var4 = this.anInt1932 == -1 || this.anInt1959 == this.anInt1932 && var3 != null ? null : Node_Sub6.getSequenceType(this.anInt1932);
         Model var2 = this.type.method799(var3, this.anInt1934, var4, this.anInt1914);
         if(var2 == null) {
            return null;
         } else {
            var2.method998();
            this.anInt1950 = var2.modelHeight * 1812947537;
            if(this.anInt1938 != -1 && this.anInt1925 != -1) {
               Model var5 = Class96_Sub1.getSpotAnimType(this.anInt1938).method656(this.anInt1925);
               if(var5 != null) {
