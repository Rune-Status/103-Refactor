   ...
   static final void method583(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
      ...
      if(var2 == 25) {
         ...
         if(var8 != null) {
            ...
            AbstractSoundSystem.method96(var1, var0, TaskManager.method314(Class30.getWidgetConfig(var8)), var8.itemId);
            ...
            if(var8.interactable) {
               ...
               Client.selectedSpellName = Class48_Sub1.method545('\uff00') + var8.aString1125 + Class48_Sub1.method545(16777215);
            }
         }
      } else {
         if(var2 == 16) {
         ...
         if(var2 == 1005) {
            ...
            if(var8 != null && var8.itemQuantities[var0] >= 100000) {
               Class75.method334(27, "", var8.itemQuantities[var0] + " x " + FriendedPlayer.getItemType(var3).name);
            } else {
               Client.outBuffer.putHeader(158);
               Client.outBuffer.putLEShortA(var3);
            }
         ...
         if(var2 == 38) {
            ...
            Client.selectedItemName = Class48_Sub1.method545(16748608) + FriendedPlayer.getItemType(var3).name + Class48_Sub1.method545(16777215);
