		...
		if (Client.frameId == 36) {
			...
			if (Client.frameId == 15) {
				...
				if (var1 >= 0 && var2 >= 0 && var1 < 104 && var2 < 104) {
					...
					if (Class68.myPlayer.anIntArray1945[0] >= var1 - var7
							...
							&& var6 > 0 && Client.audioEffectCount < 50) {
			...
			if (Client.frameId == 220) {
				...
				if (var1 >= 0 && var2 >= 0 && var1 < 104 && var2 < 104) {
					...
					if (var40 != null) {
						for (GroundItem var8 = (GroundItem) var40.getFront(); var8 != null; var8 = (GroundItem) var40
								.getNext()) {
				...
				if (Client.frameId == 25) {
					...
					if (var5 >= 0 && var6 >= 0 && var5 < 103 && var6 < 103) {
							...
							if (var34 != null) {
								...
								if (var1 == 2) {
									var34.entityA = new DynamicObject(var33, 2, var2 + 4,
											...
											var34.entityA);
									var34.entityB = new DynamicObject(var33, 2, var2 + 1 & 0x3,
											InterfaceNode.floorLevel * -1331355705, var5, var6, var9, false,
											var34.entityB);
								} else {
									var34.entityA = new DynamicObject(var33, var1, var2,
											InterfaceNode.floorLevel * -1331355705, var5, var6, var9, false,
											var34.entityA);
								}
							}
							...
							if (var35 != null) {
								...
								if (var1 != 4 && var1 != 5) {
									if (var1 == 6) {
										...
										var35.entityA = new DynamicObject(var33, 4, (var2 + 2 & 0x3) + 4,
												InterfaceNode.floorLevel * -1331355705, var5, var6, var9, false,
												var35.entityA);
									} else if (var1 == 8) {
										var35.entityA = new DynamicObject(var33, 4, var2 + 4,
												InterfaceNode.floorLevel * -1331355705, var5, var6, var9, false,
												var35.entityA);
										var35.entityB = new DynamicObject(var33, 4, (var2 + 2 & 0x3) + 4,
												InterfaceNode.floorLevel * -1331355705, var5, var6, var9, false,
												var35.entityB);
									}
								} else {
									var35.entityA = new DynamicObject(var33, 4, var2,
											InterfaceNode.floorLevel * -1331355705, var5, var6, var9, false,
											var35.entityA);
								}
							}
						...
						if (var3 == 2) {
							EntityMarker var36 = InterfaceNode.landscape
									.method30(InterfaceNode.floorLevel * -1331355705, var5, var6);
							if (var1 == 11) {
								var1 = 10;
							}
					...
					if (var1 >= 0 && var2 >= 0 && var1 < 104 && var2 < 104) {
						NpcType.method805(InterfaceNode.floorLevel * -1331355705, var1, var2, var6, -1, var32, var5, 0,
								-1);
					}
					...
					if (Client.frameId == 108) {
						...
						if (var1 >= 0 && var2 >= 0 && var1 < 104 && var2 < 104 && var3 >= 0 && var32 >= 0 && var3 < 104
								&& var32 < 104 && var6 != '\uffff') {
							var1 = var1 * 128 + 64;
							var2 = var2 * 128 + 64;
							var3 = var3 * 128 + 64;
						...
						if (Client.frameId == 189) {
							...
							var9 = Client.inBuffer.getUShort();
							if (var1 >= 0 && var2 >= 0 && var1 < 104 && var2 < 104) {
								NpcType.method805(InterfaceNode.floorLevel * -1331355705, var1, var2, var6, var9, var32,
										var5, 0, -1);
							}
						}
					}
