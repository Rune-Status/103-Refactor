   ...
   static final boolean method512(int var0, int var1, int var2, Class48 var3, CollisionMap var4) {
      ...
      while(true) {
         ...
         while(true) {
               ...
               do {
                  do {
                     ...
                     do {
                        ...
                        if(var18 > 0 && Class58.anIntArrayArray543[var18 - 1][var19] == 0 && (var14[var15 - 1][var16] & 0x124010e) == 0 && (var14[var15 - 1][var16 + var2 - 1] & 0x1240138) == 0) {
                           var12 = 1;
                        ...
                        if(var18 < 128 - var2 && Class58.anIntArrayArray543[var18 + 1][var19] == 0 && (var14[var2 + var15][var16] & 0x1240183) == 0 && (var14[var15 + var2][var16 + var2 - 1] & 0x12401e0) == 0) {
                           var12 = 1;
                        ...
                        if(var19 > 0 && Class58.anIntArrayArray543[var18][var19 - 1] == 0 && (var14[var15][var16 - 1] & 0x124010e) == 0 && (var14[var15 + var2 - 1][var16 - 1] & 0x1240183) == 0) {
                           var12 = 1;
                        ...
                        if(var19 < 128 - var2 && Class58.anIntArrayArray543[var18][var19 + 1] == 0 && (var14[var15][var2 + var16] & 0x1240138) == 0 && (var14[var15 + var2 - 1][var16 + var2] & 0x12401e0) == 0) {
                           var12 = 1;
                        ...
                        if(var18 > 0 && var19 > 0 && Class58.anIntArrayArray543[var18 - 1][var19 - 1] == 0 && (var14[var15 - 1][var16 - 1] & 0x124010e) == 0) {
                           var12 = 1;
                           ...
                           while(true) {
                              ...
                              if((var14[var15 - 1][var16 - 1 + var12] & 0x124013e) != 0 || (var14[var15 - 1 + var12][var16 - 1] & 0x124018f) != 0) {
                                 break;
                              }
                        ...
                        if(var18 < 128 - var2 && var19 > 0 && Class58.anIntArrayArray543[var18 + 1][var19 - 1] == 0 && (var14[var15 + var2][var16 - 1] & 0x1240183) == 0) {
                           var12 = 1;
                           ...
                           while(true) {
                              ...
                              if((var14[var2 + var15][var16 - 1 + var12] & 0x12401e3) != 0 || (var14[var12 + var15][var16 - 1] & 0x124018f) != 0) {
                                 break;
                              }
                        ...
                        if(var18 > 0 && var19 < 128 - var2 && Class58.anIntArrayArray543[var18 - 1][var19 + 1] == 0 && (var14[var15 - 1][var16 + var2] & 0x1240138) == 0) {
                           for(var12 = 1; var12 < var2; var12++) {
                              if((var14[var15 - 1][var16 + var12] & 0x124013e) != 0 || (var14[var15 - 1 + var12][var16 + var2] & 0x12401f8) != 0) {
                                 continue label218;
                              }
                           }
            ...
            for(var12 = 1; var12 < var2; var12++) {
               if((var14[var15 + var12][var2 + var16] & 0x12401f8) != 0 || (var14[var15 + var2][var12 + var16] & 0x12401e3) != 0) {
                  continue label241;
               }
            }
