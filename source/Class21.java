public class Class21 {
         ...
         while(true) {
            ...
            while(!var8) {
               ...
               if(var10 > 0 && var13 > 0 && var10 < 103 && var13 < 103) {
                  ...
                  if(var14 != 22 || !Client.lowMemory || var15.anInt1692 != 0 || var15.anInt1690 == 1 || var15.aBool1711) {
                     if(!var15.method867()) {
                        ++Client.anInt2049;
                        var3 = false;
                     }
   ...
   static final void method156(Player var0, int var1, int var2, byte var3) {
      ...
      if(var4 >= var6 && var4 < 104 - var6 && var7 >= var6 && var7 < 104 - var6 && var1 >= var6 && var1 < 104 - var6 && var2 >= var6 && var2 < 104 - var6) {
         ...
         int var10 = Class39.method218(var4, var7, var9, var11, Client.collisionMaps[var0.anInt2004], true, Client.anIntArray2235, Client.anIntArray2236);
         if(var10 >= 1) {
   ...
   static int method157(int var0) {
      ...
      return var1 == null ? -1 : (var1.dualPrevious == Class32.aClass108_354.aDualNode771 ? -1 : ((DualNode_Sub8)var1.dualPrevious).anInt1516);
   }
