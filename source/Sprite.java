...
public final class Sprite extends Raster {
	...
	public Sprite copy() {
		...
		for (int var3 = 0; var3 < this.subHeight; var3++) {
			for (int var2 = 0; var2 < this.subWidth; var2++) {
				var1.pixels[(this.offsetY + var3) * this.width + var2 + this.offsetX] = this.pixels[this.subWidth * var3
						+ var2];
			}
		}
	...
	static void method947(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
		...
		for (int var11 = -var6; var11 < 0; var11++) {
			for (int var12 = -var5; var12 < 0; var12++) {
				...
				if (var2 != 0) {
					int var13 = var0[var4];
					var0[var4++] = ((var2 & 0xff00ff) * var9 + (var13 & 0xff00ff) * var10 & 0xff00ff00)
							+ ((var2 & 0xff00) * var9 + (var13 & 0xff00) * var10 & 0xff0000) >> 8;
				} else {
					++var4;
				}
			}
		...
		if (this.subWidth != this.width || this.subHeight != this.height) {
			...
			for (int var3 = 0; var3 < this.subHeight; var3++) {
				for (int var1 = 0; var1 < this.subWidth; var1++) {
					var2[(this.offsetY + var3) * this.width + var1 + this.offsetX] = this.pixels[this.subWidth * var3
							+ var1];
				}
			}
	...
	public Sprite(byte[] var1, Component var2) {
		try {
			...
			PixelGrabber var5 = new PixelGrabber(var3, 0, 0, this.subWidth, this.subHeight, this.pixels, 0,
					this.subWidth);
			var5.grabPixels();
	...
	static void method963(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
		...
		for (int var14 = -var8; var14 < 0; var14++) {
			...
			for (int var16 = -var7; var16 < 0; var16++) {
				...
				if (var2 != 0) {
					int var17 = var0[var5];
					var0[var5++] = ((var2 & 0xff00ff) * var12 + (var17 & 0xff00ff) * var13 & 0xff00ff00)
							+ ((var2 & 0xff00) * var12 + (var17 & 0xff00) * var13 & 0xff0000) >> 8;
				} else {
					++var5;
				}
