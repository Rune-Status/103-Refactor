...
public final class Sprite extends RSGraphics {
	...
	public Sprite(int var1, int var2) {
		...
		this.height = this.anInt1815 = var1;
		this.width = this.anInt1816 = var2;
		this.anInt1817 = 0;
		this.anInt1814 = 0;
	}

	public Sprite method937() {
		Sprite var1 = new Sprite(this.height, this.width);
		var1.anInt1815 = this.anInt1815;
		var1.anInt1816 = this.anInt1816;
		var1.anInt1814 = this.anInt1815 - this.height - this.anInt1814;
		var1.anInt1817 = this.anInt1817;

		for (int var3 = 0; var3 < this.width; ++var3) {
			for (int var2 = 0; var2 < this.height; ++var2) {
				var1.pixels[var3 * this.height + var2] = this.pixels[var3 * this.height + this.height - 1 - var2];
			}
		}
	...
	public Sprite copy() {
		...
		for (int var3 = 0; var3 < this.width; ++var3) {
			for (int var2 = 0; var2 < this.height; ++var2) {
				var1.pixels[(var3 + this.anInt1817) * this.anInt1815 + var2
						+ this.anInt1814] = this.pixels[var3 * this.height + var2];
			}
		}
	...
	public void method941(int var1) {
		if (this.height != this.anInt1815 || this.width != this.anInt1816) {
			int var5 = var1;
			if (var1 > this.anInt1814) {
				var5 = this.anInt1814;
			}

			int var6 = var1;
			if (var1 + this.anInt1814 + this.height > this.anInt1815) {
				var6 = this.anInt1815 - this.anInt1814 - this.height;
			}

			int var2 = var1;
			if (var1 > this.anInt1817) {
				var2 = this.anInt1817;
			}

			int var3 = var1;
			if (var1 + this.anInt1817 + this.width > this.anInt1816) {
				var3 = this.anInt1816 - this.anInt1817 - this.width;
			}

			int var7 = this.height + var5 + var6;
			int var4 = this.width + var2 + var3;
			int[] var8 = new int[var7 * var4];

			for (int var9 = 0; var9 < this.width; ++var9) {
				for (int var10 = 0; var10 < this.height; ++var10) {
					var8[(var9 + var2) * var7 + var10 + var5] = this.pixels[var9 * this.height + var10];
				}
			}
	...
	public void method942() {
		int[] var1 = new int[this.height * this.width];
		int var4 = 0;

		for (int var2 = 0; var2 < this.width; ++var2) {
			for (int var3 = this.height - 1; var3 >= 0; --var3) {
				var1[var4++] = this.pixels[var3 + var2 * this.height];
			}
		}

		this.pixels = var1;
		this.anInt1814 = this.anInt1815 - this.height - this.anInt1814;
	}
	...
	public void method943() {
		...
		this.pixels = var1;
		this.anInt1817 = this.anInt1816 - this.width - this.anInt1817;
	}
	...
	public void method944(int var1, int var2, int var3, int var4) {
		if (var3 > 0 && var4 > 0) {
			...
			int var7 = 0;
			int var9 = 0;
			int var12 = this.anInt1815;
			int var10 = this.anInt1816;
			int var8 = (var12 << 16) / var3;
			int var14 = (var10 << 16) / var4;
			int var13;
			if (this.anInt1814 > 0) {
				var13 = ((this.anInt1814 << 16) + var8 - 1) / var8;
				var1 += var13;
				var7 += var13 * var8 - (this.anInt1814 << 16);
			}

			if (this.anInt1817 > 0) {
				var13 = ((this.anInt1817 << 16) + var14 - 1) / var14;
				var2 += var13;
				var9 += var13 * var14 - (this.anInt1817 << 16);
			}
	...
	public void method945(int var1, int var2, int var3, int var4) {
		this.method956(this.anInt1815 << 3, this.anInt1816 << 3, var1 << 4, var2 << 4, var3, var4);
	}
	...
	public void method948() {
		if (this.height != this.anInt1815 || this.width != this.anInt1816) {
			int[] var2 = new int[this.anInt1815 * this.anInt1816];

			for (int var3 = 0; var3 < this.width; ++var3) {
				for (int var1 = 0; var1 < this.height; ++var1) {
					var2[(var3 + this.anInt1817) * this.anInt1815 + var1
							+ this.anInt1814] = this.pixels[var3 * this.height + var1];
				}
			}

			this.pixels = var2;
			this.height = this.anInt1815;
			this.width = this.anInt1816;
			this.anInt1814 = 0;
			this.anInt1817 = 0;
		}
	}
			...
			for (int var6 = 0; var6 < this.height; ++var6) {
				...
				if (var5 == 0) {
					if (var6 > 0 && this.pixels[var3 - 1] != 0) {
						var5 = var1;
					} else if (var4 > 0 && this.pixels[var3 - this.height] != 0) {
						var5 = var1;
					} else if (var6 < this.height - 1 && this.pixels[var3 + 1] != 0) {
						var5 = var1;
					} else if (var4 < this.width - 1 && this.pixels[var3 + this.height] != 0) {
						var5 = var1;
					}
				}
	...
	public void method953(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) {
			...
			int var6 = 0;
			int var11 = 0;
			int var14 = this.anInt1815;
			int var15 = this.anInt1816;
			int var8 = (var14 << 16) / var3;
			int var13 = (var15 << 16) / var4;
			int var7;
			if (this.anInt1814 > 0) {
				var7 = ((this.anInt1814 << 16) + var8 - 1) / var8;
				var1 += var7;
				var6 += var7 * var8 - (this.anInt1814 << 16);
			}

			if (this.anInt1817 > 0) {
				var7 = ((this.anInt1817 << 16) + var13 - 1) / var13;
				var2 += var7;
				var11 += var7 * var13 - (this.anInt1817 << 16);
			}
	...
	public void method954(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
		...
		int var11 = var2 + this.width > var6 ? var6 - var2 : this.width;
		int var9 = var1 < 0 ? -var1 : 0;
		int var10000;
		if (var1 + this.height <= var5) {
		...
		for (int var17 = var16; var17 < var11; ++var17) {
			...
			int var13;
			if (var1 + this.height <= var12 + var19) {
				var13 = this.height;
			} else {
	...
	public Sprite(byte[] var1, Component var2) {
		try {
			...
			var4.waitForAll();
			this.height = var3.getWidth(var2);
			this.width = var3.getHeight(var2);
			this.anInt1815 = this.height;
			this.anInt1816 = this.width;
			this.anInt1814 = 0;
			this.anInt1817 = 0;
			this.pixels = new int[this.height * this.width];
			PixelGrabber var5 = new PixelGrabber(var3, 0, 0, this.height, this.width, this.pixels, 0, this.height);
			var5.grabPixels();
	...
	void method956(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var6 != 0) {
			var1 -= this.anInt1814 << 4;
			var2 -= this.anInt1817 << 4;
			...
			int var18 = ((this.height << 4) - var1) * var15 + -var2 * var14;
			int var19 = -((this.height << 4) - var1) * var14 + -var2 * var15;
			int var20 = -var1 * var15 + ((this.width << 4) - var2) * var14;
			int var33 = -(-var1) * var14 + ((this.width << 4) - var2) * var15;
			int var29 = ((this.height << 4) - var1) * var15 + ((this.width << 4) - var2) * var14;
			int var23 = -((this.height << 4) - var1) * var14 + ((this.width << 4) - var2) * var15;
			int var28;
			int var30;
			if (var16 < var18) {
				var28 = var16;
					...
					if (var25 == 0) {
						if (var10 == 0) {
							for (var34 = var7; var34 < 0; var32 += raster_width) {
								...
								var11 = var8;
								var31 = var30;
								if (var37 >= 0 && var8 >= 0 && var37 - (this.height << 12) < 0
										&& var8 - (this.width << 12) < 0) {
									for (; var31 < 0; ++var31) {
							...
							for (var34 = var7; var34 < 0; var32 += raster_width) {
								...
								var31 = var30;
								if (var37 >= 0 && var37 - (this.height << 12) < 0) {
									if ((var27 = var11 - (this.width << 12)) >= 0) {
							...
							for (var34 = var7; var34 < 0; var32 += raster_width) {
								...
								if (var37 >= 0 && var37 - (this.height << 12) < 0) {
									...
									if ((var27 = (1 + var11 - (this.width << 12) - var10) / var10) > var31) {
										var31 = var27;
									}
						...
						if (var10 == 0) {
							for (var34 = var7; var34 < 0; var32 += raster_width) {
								...
								if (var8 >= 0 && var8 - (this.width << 12) < 0) {
									if ((var27 = var26 - (this.height << 12)) >= 0) {
						...
						for (var34 = var7; var34 < 0; var32 += raster_width) {
							...
							if (var8 >= 0 && var8 - (this.width << 12) < 0) {
								...
								if ((var27 = (1 + var26 - (this.height << 12) - var25) / var25) > var31) {
									var31 = var27;
								}
	...
	public void method962(int var1) {
		for (int var2 = this.width - 1; var2 > 0; --var2) {
			int var3 = var2 * this.height;

			for (int var4 = this.height - 1; var4 > 0; --var4) {
				if (this.pixels[var4 + var3] == 0 && this.pixels[var4 + var3 - 1 - this.height] != 0) {
