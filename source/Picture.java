...
public final class Picture extends RSGraphics {
   ...
   public Picture method937() {
      ...
      for(int var3 = 0; var3 < this.subHeight; var3++) {
         for(int var2 = 0; var2 < this.subWidth; var2++) {
            var1.pixels[this.subWidth * var3 + var2] = this.pixels[this.subWidth * var3 + this.subWidth - 1 - var2];
         }
      }
   ...
   public Picture copy() {
      ...
      for(int var3 = 0; var3 < this.subHeight; var3++) {
         for(int var2 = 0; var2 < this.subWidth; var2++) {
            var1.pixels[(this.offsetY + var3) * this.width + var2 + this.offsetX] = this.pixels[this.subWidth * var3 + var2];
         }
      }
   ...
   public void method941(int var1) {
      if(this.subWidth != this.width || this.subHeight != this.height) {
         ...
         int var6 = var1;
         if(this.offsetX + var1 + this.subWidth > this.width) {
         ...
         int var3 = var1;
         if(this.offsetY + var1 + this.subHeight > this.height) {
         ...
         for(int var9 = 0; var9 < this.subHeight; var9++) {
            for(int var10 = 0; var10 < this.subWidth; var10++) {
               var8[(var9 + var2) * var7 + var10 + var5] = this.pixels[this.subWidth * var9 + var10];
            }
         }
   ...
   public void method942() {
      ...
      for(int var2 = 0; var2 < this.subHeight; var2++) {
         for(int var3 = this.subWidth - 1; var3 >= 0; --var3) {
            var1[var4++] = this.pixels[this.subWidth * var2 + var3];
         }
      }
   ...
   public void method946(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      int var3 = raster_width * var2 + var1;
      int var5 = 0;
   ...
   static void method947(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      int var10 = 256 - var9;
      ...
      for(int var11 = -var6; var11 < 0; var11++) {
         for(int var12 = -var5; var12 < 0; var12++) {
            ...
            if(var2 != 0) {
               int var13 = var0[var4];
               var0[var4++] = ((var2 & 0xff00ff) * var9 + (var13 & 0xff00ff) * var10 & 0xff00ff00) + ((var2 & 0xff00) * var9 + (var13 & 0xff00) * var10 & 0xff0000) >> 8;
            } else {
               ++var4;
            }
         }
      ...
      if(this.subWidth != this.width || this.subHeight != this.height) {
         ...
         for(int var3 = 0; var3 < this.subHeight; var3++) {
            for(int var1 = 0; var1 < this.subWidth; var1++) {
               var2[(this.offsetY + var3) * this.width + var1 + this.offsetX] = this.pixels[this.subWidth * var3 + var1];
            }
         }
   ...
   static void method949(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
         ...
         for(int var6 = 0; var6 < this.subWidth; var6++) {
            ...
            if(var5 == 0) {
               if(var6 > 0 && this.pixels[var3 - 1] != 0) {
                  ...
                  var5 = var1;
               } else if(var4 < this.subHeight - 1 && this.pixels[this.subWidth + var3] != 0) {
                  var5 = var1;
               }
            }
   ...
   public void method954(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
      ...
      int var11 = this.subHeight + var2 > var6 ? var6 - var2 : this.subHeight;
      int var9 = var1 < 0 ? -var1 : 0;
      if(this.subWidth + var1 <= var5) {
         int var10000 = this.subWidth;
      } else {
         int var100001 = var5 - var1;
      }
      ...
      for(int var17 = var16; var17 < var11; var17++) {
         ...
         if(var1 < var12) {
            var10 = var12 - var1;
            var20 = var10 - var9 + var14;
         } else {
            var10 = var9;
         }

         int var13;
         if(this.subWidth + var1 <= var12 + var19) {
            var13 = this.subWidth;
         } else {
         ...
         for(int var15 = var10; var15 < var13; var15++) {
            int var21 = this.pixels[this.subWidth * var17 + var15];
            if(var21 != 0) {
               raster[var20++] = var21;
            } else {
               ++var20;
   ...
   public void method955(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
      try {
         ...
         int var16 = raster_width * var2 + var1;
   ...
   void method956(int var1, int var2, int var3, int var4, int var5, int var6) {
      if(var6 != 0) {
         ...
         if(var30 < 0) {
            var7 = var24 - var7;
            if(var7 < 0) {
               int var32 = raster_width * var24 + var28;
               ...
               if(var25 == 0) {
                  if(var10 == 0) {
                     for(var34 = var7; var34 < 0; var32 += raster_width) {
                        ...
                        var11 = var8;
                        var31 = var30;
                        if(var37 >= 0 && var8 >= 0 && var37 - (this.subWidth << 12) < 0 && var8 - (this.subHeight << 12) < 0) {
                           for(; var31 < 0; var31++) {
                     ...
                     for(var34 = var7; var34 < 0; var32 += raster_width) {
                        ...
                        if(var37 >= 0 && var37 - (this.subWidth << 12) < 0) {
                           ...
                           if((var27 = (var11 + 1 - (this.subHeight << 12) - var10) / var10) > var31) {
                              var31 = var27;
                           }
                  ...
                  for(var34 = var7; var34 < 0; var32 += raster_width) {
                     ...
                     if(var8 >= 0 && var8 - (this.subHeight << 12) < 0) {
                        ...
                        if((var27 = (var26 + 1 - (this.subWidth << 12) - var25) / var25) > var31) {
                           var31 = var27;
                        }
   ...
   public void method957(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9, int[] var10) {
      try {
         int var11 = -var3 / 2;
         int var12 = -var4 / 2;
         ...
         int var17 = raster_width * var2 + var1;
   ...
   public void method958(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      int var5 = raster_width * var2 + var1;
      int var6 = 0;
      int var7 = this.subHeight;
      int var8 = this.subWidth;
      int var9 = raster_width - var8;
   ...
   static void method959(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 0x3);
   ...
   static void method961(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      int var11 = 256 - var9;
      int var13 = (var10 & 0xff00ff) * var11 & 0xff00ff00;
      int var14 = (var10 & 0xff00) * var11 & 0xff0000;
      var10 = (var13 | var14) >>> 8;
      ...
      for(int var15 = -var6; var15 < 0; var15++) {
         for(int var12 = -var5; var12 < 0; var12++) {
            var2 = var1[var3++];
            if(var2 != 0) {
               var13 = (var2 & 0xff00ff) * var9 & 0xff00ff00;
               var14 = (var2 & 0xff00) * var9 & 0xff0000;
   ...
   static void method963(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
      int var13 = 256 - var12;
      int var18 = var3;
      ...
      for(int var14 = -var8; var14 < 0; var14++) {
         ...
         for(int var16 = -var7; var16 < 0; var16++) {
            ...
            if(var2 != 0) {
               int var17 = var0[var5];
               var0[var5++] = ((var2 & 0xff00ff) * var12 + (var17 & 0xff00ff) * var13 & 0xff00ff00) + ((var2 & 0xff00) * var12 + (var17 & 0xff00) * var13 & 0xff0000) >> 8;
            } else {
               ++var5;
            }
