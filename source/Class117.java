...
public final class Class117 {
	...
	static final int method442(Widget var0, int var1) {
		if (var0.varpOpcodes != null && var1 < var0.varpOpcodes.length) {
			try {
				int[] var2 = var0.varpOpcodes[var1];
				int var3 = 0;
				int var4 = 0;
				byte var5 = 0;
				...
				while (true) {
					...
					if (var6 == 5) {
						var7 = Class94.tempVars[var2[var4++]];
					}

					if (var6 == 6) {
						var7 = Class65.anIntArray582[Client.experiences[var2[var4++]] - 1];
					}

					if (var6 == 7) {
						var7 = Class94.tempVars[var2[var4++]] * 100 / '\ub71b';
					}

					if (var6 == 8) {
						var7 = Class68.myPlayer.combatLevel * 1614853309;
					}
					...
					if (var6 == 11) {
						var7 = Client.energy * -1005815685;
					}

					if (var6 == 12) {
						var7 = Client.weight * -1944031695;
					}

					if (var6 == 13) {
						var9 = Class94.tempVars[var2[var4++]];
						int var14 = var2[var4++];
					...
					if (var6 == 19) {
						var7 = (Class68.myPlayer.strictY * -1801433343 >> 7) + 714823515 * Class28.regionBaseY;
					}
