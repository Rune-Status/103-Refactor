      ...
      if(!Client.dynamicRegion) {
         ...
         for(plane = (var3 - 6) / 8; plane <= (var3 + 6) / 8; plane++) {
            for(var1 = (var2 - 6) / 8; var1 <= (var2 + 6) / 8; var1++) {
               var9 = (plane << 8) + var1;
               if(!var11 || var1 != 49 && var1 != 149 && var1 != 147 && plane != 50 && (plane != 49 || var1 != 47)) {
                  GameClient.dumpMap(var9, SkeletonSet.regionXTEAs[region_count]);
                  Client.regionIds[region_count] = var9;
                  Class69.mapRegionFileIds[region_count] = Class48_Sub1.landscapesIndex.getFile("m" + plane + "_" + var1);
                  InvType.landRegionFielIds[region_count] = Class48_Sub1.landscapesIndex.getFile("l" + plane + "_" + var1);
                  ++region_count;
               }
            }
         }
               ...
               for(var1 = 0; var1 < 13; var1++) {
                  ...
                  if(var9 != -1) {
                     ...
                     if(var8 != -1) {
                        ...
                        var4 = var8 >> 8 & 0xff;
                        int var10 = var8 & 0xff;
                        Class69.mapRegionFileIds[region_count] = Class48_Sub1.landscapesIndex.getFile("m" + var4 + "_" + var10);
                        InvType.landRegionFielIds[region_count] = Class48_Sub1.landscapesIndex.getFile("l" + var4 + "_" + var10);
                        ++region_count;
                     }
                  }
               }
   ...
   static final void decodeNpcUpdate(boolean largeScene) {
      ...
      if(var1 > Client.anInt2225) {
         ...
         while(Client.inBuffer.bitsAvail(Client.frameSize) >= 27) {
            ...
            var11.method1025(Class68.myPlayer.anIntArray1945[0] + var2, Class68.myPlayer.anIntArray1955[0] + var12, var7 == 1);
         }
