public class Class59 {
   ...
   static void method292(int var0, IndexTable var1, CacheIndex var2) {
      ...
      synchronized(var4) {
         for(Node_Sub9 var5 = (Node_Sub9)Class90.aDeque718.getFront(); var5 != null; var5 = (Node_Sub9)Class90.aDeque718.getNext()) {
   ...
   static Class resolveType(String var0) throws ClassNotFoundException {
      return var0.equals("B") ? Byte.TYPE : (var0.equals("I") ? Integer.TYPE : (var0.equals("S") ? Short.TYPE : (var0.equals("J") ? Long.TYPE : (var0.equals("Z") ? Boolean.TYPE : (var0.equals("F") ? Float.TYPE : (var0.equals("D") ? Double.TYPE : (var0.equals("C") ? java.lang.Character.TYPE : (var0.equals("void") ? Void.TYPE : Class.forName(var0)))))))));
   }
