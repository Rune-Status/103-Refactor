...
public class Class13 {
	...
	static final void method117() {
		...
		RSGraphics.noClip();
		var1 = 0;
		int var2 = IndexTable.imageProducer.width * 1802935495 + 1933284923 * Class6.anInt132;
		...
		for (var5 = 1; var5 < var0 - 1; ++var5) {
			...
			for (var6 = var4; var6 < 128; ++var6) {
				...
				if (var3 != 0) {
					...
					IndexTable.imageProducer.dataArray[var2++] = (var8 * (var9 & 16711935) + var10 * (var3 & 16711935)
			...
			var2 += var4 + 1154763343 * IndexTable.imageProducer.width - 128;
		}
		...
		RSGraphics.noClip();
		var1 = 0;
		var2 = 637 + 24 + 1802935495 * IndexTable.imageProducer.width + Class6.anInt132 * 1933284923;
		...
		for (var5 = 1; var5 < var0 - 1; ++var5) {
			...
			for (var6 = 0; var6 < var4; ++var6) {
				...
				if (var3 != 0) {
					...
					var3 = Class6.anIntArray124[var3];
					var9 = IndexTable.imageProducer.dataArray[var2];
					IndexTable.imageProducer.dataArray[var2++] = (var10 * (var3 & '\uff00') + var8 * (var9 & '\uff00')
			...
			var1 += 128 - var4;
			var2 += IndexTable.imageProducer.width * 1154763343 - var4 - var7;
		}
