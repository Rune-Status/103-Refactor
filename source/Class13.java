public class Class13 {
      ...
      if(Class6.anInt138 > 0) {
         for(var1 = 0; var1 < 256; var1++) {
            if(Class6.anInt138 > 768) {
               Class6.anIntArray124[var1] = ByteBuf.method637(TileDecorationStub.anIntArray841[var1], Class118.anIntArray803[var1], 1024 - Class6.anInt138);
            } else if(Class6.anInt138 <= 256) {
               Class6.anIntArray124[var1] = ByteBuf.method637(Class118.anIntArray803[var1], TileDecorationStub.anIntArray841[var1], 256 - Class6.anInt138);
            } else {
         ...
         for(var1 = 0; var1 < 256; var1++) {
            if(Class6.anInt127 > 768) {
               Class6.anIntArray124[var1] = ByteBuf.method637(TileDecorationStub.anIntArray841[var1], Class6.anIntArray125[var1], 1024 - Class6.anInt127);
            } else if(Class6.anInt127 > 256) {
               Class6.anIntArray124[var1] = Class6.anIntArray125[var1];
            } else {
               Class6.anIntArray124[var1] = ByteBuf.method637(Class6.anIntArray125[var1], TileDecorationStub.anIntArray841[var1], 256 - Class6.anInt127);
            }
         }
      } else {
         for(var1 = 0; var1 < 256; var1++) {
      ...
      for(var5 = 1; var5 < var0 - 1; var5++) {
         ...
         for(var6 = var4; var6 < 128; var6++) {
            ...
            if(var3 != 0) {
               ...
               IndexTable.imageProducer.dataArray[var2++] = ((var9 & 0xff00ff) * var8 + (var3 & 0xff00ff) * var10 & 0xff00ff00) + ((var9 & 0xff00) * var8 + (var3 & 0xff00) * var10 & 0xff0000) >> 8;
            } else {
               ++var2;
            }
         }
      ...
      for(var5 = 1; var5 < var0 - 1; var5++) {
         ...
         for(var6 = 0; var6 < var4; var6++) {
            ...
            if(var3 != 0) {
               ...
               var3 = Class6.anIntArray124[var3];
               var9 = IndexTable.imageProducer.dataArray[var2];
               IndexTable.imageProducer.dataArray[var2++] = ((var3 & 0xff00) * var10 + (var9 & 0xff00) * var8 & 0xff0000) + ((var3 & 0xff00ff) * var10 + (var9 & 0xff00ff) * var8 & 0xff00ff00) >> 8;
            } else {
               ++var2;
            }
         }
   ...
   static final void method118(int var0, int var1, int var2, int var3, boolean var4) {
      ...
      Client.screenZoom = (var3 * var8 * var12 / 85504 << 1) * 96042709;
