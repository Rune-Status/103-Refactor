...
public final class Player extends Character {
   ...
   protected final Model method654(byte var1) {
      if(this.config == null) {
         ...
         SequenceType var6 = this.animation != -1 && this.anInt1936 == 0 ? Node_Sub6.getSequenceType(this.animation) : null;
         SequenceType var3 = this.anInt1932 == -1 || this.aBool1996 || this.anInt1932 == this.anInt1959 && var6 != null ? null : Node_Sub6.getSequenceType(this.anInt1932);
         Model var4 = this.config.method268(var6, this.anInt1934, var3, this.anInt1914);
         if(var4 == null) {
            return null;
         } else {
            var4.method998();
            this.anInt1950 = var4.modelHeight * 1812947537;
            Model var2;
            Model[] var5;
            ...
            if(!this.aBool1996 && this.aModel2001 != null) {
               ...
               if(Client.engineCycle >= this.anInt1989 && Client.engineCycle < this.anInt1990) {
                  ...
                  var2.method1008(this.anInt1991 - this.strictX, this.anInt1992 - this.anInt1997, this.anInt1993 - this.strictY);
                  ...
                  var2.method1008(this.strictX - this.anInt1991, this.anInt1997 - this.anInt1992, this.strictY - this.anInt1993);
               }
            }
   ...
   final void method1045(int var1, int var2, byte var3) {
      ...
      if(var1 >= 0 && var1 < 104 && var2 >= 0 && var2 < 104) {
         if(this.anIntArray1945[0] >= 0 && this.anIntArray1945[0] < 104 && this.anIntArray1955[0] >= 0 && this.anIntArray1955[0] < 104) {
            if(var3 == 2) {
   ...
   int getSize() {
      return this.config != null && this.config.npcId != -1 ? VarPlayerType.getNpcType(this.config.npcId).anInt1589 : 1;
   }
   ...
   static void decodeMovement(BitBuf var0, int var1) {
      ...
      if(var7 == 0) {
         if(var5) {
            ...
            GPI.cachedRegions[var1] = (var3.anInt2004 << 28) + (Node_Sub10.chunkLeftX + var3.anIntArray1945[0] >> 6 << 14) + (VarClientHub.chunkLeftY + var3.anIntArray1955[0] >> 6);
            if(var3.anInt1931 != -1) {
         ...
         if(var7 == 1) {
            ...
            if(Client.myPlayerIndex != var1 || var3.strictX >= 1536 && var3.strictY >= 1536 && var3.strictX < 11776 && var3.strictY < 11776) {
               if(var5) {
                  var3.aBool1999 = true;
                  var3.anInt2002 = var4;
                  var3.anInt2003 = var6;
            ...
            if(var2 == 0) {
               ...
               var8 = (VarClientHub.chunkLeftY + var10 + var3.anIntArray1955[0] & 0x3fff) - VarClientHub.chunkLeftY;
               if(Client.myPlayerIndex == var1 && (var3.strictX < 1536 || var3.strictY < 1536 || var3.strictX >= 11776 || var3.strictY >= 11776)) {
                  var3.method1043(var9, var8);
                  var3.aBool1999 = false;
               } else if(var5) {
   ...
   static String method1049(Widget var0, int var1) {
      return !Node_Sub10.method569(Class30.getWidgetConfig(var0), var1) && var0.anObjectArray1180 == null ? null : (var0.actions != null && var0.actions.length > var1 && var0.actions[var1] != null && var0.actions[var1].trim().length() != 0 ? var0.actions[var1] : null);
   }
   ...
   static boolean method1050(String var0, int var1, String var2) {
      if(var1 == 0) {
         ...
         try {
            Object var10 = JSHelper.call(Class70.anApplet587, var2, new Object[]{(new URL(Class70.anApplet587.getCodeBase(), var0)).toString()});
            return var10 != null;
         ...
         try {
            Class70.anApplet587.getAppletContext().showDocument(new URL(Class70.anApplet587.getCodeBase(), var0), "_blank");
            return true;
         ...
         try {
            Class70.anApplet587.getAppletContext().showDocument(new URL(Class70.anApplet587.getCodeBase(), var0), "_top");
            return true;
