...
public abstract class DualNode_Sub13_Sub3 extends DualNode_Sub13 {
			...
			for (var11 = 0; var11 < 256; ++var11) {
				if (var11 != 32 && var11 != 160) {
					for (var6 = 0; var6 < 256; ++var6) {
						if (var6 != 32 && var6 != 160) {
							this.aByteArray1821[(var11 << 8) + var6] = (byte) method986(var10, var14, var9,
									this.anIntArray1826, var12, var11, var6);
						}
					}
				}
			}

			this.anInt1824 = var9[32] + var12[32];
		}
	...
	public void method966(String var1, int var2, int var3, int var4, int var5, int var6) {
		if (var1 != null) {
			...
			anInt1835 = 192 + (aRandom1828.nextInt() & 31);
			int[] var9 = new int[var1.length()];
			int var8 = 0;

			for (int var7 = 0; var7 < var1.length(); ++var7) {
				var9[var7] = var8;
				if ((aRandom1828.nextInt() & 3) == 0) {
					++var8;
				}
			}
			...
			if (var1.charAt(var6) != 0) {
				...
				if (var7 == 60) {
					...
					if (var4 == -1) {
						...
						int var14 = this.anIntArray1820[var7];
						var10 = this.anIntArray1832[var7];
						if (var7 != 32) {
							if (anInt1835 == 256) {
								if (anInt1830 != -1) {
									method977(this.aByteArrayArray1819[var7], var2 + this.anIntArray1822[var7] + 1,
											var3 + this.anIntArray1823[var7] + 1, var14, var10, anInt1830);
								}

								this.method989(this.aByteArrayArray1819[var7], var2 + this.anIntArray1822[var7],
										var3 + this.anIntArray1823[var7], var14, var10, anInt1834);
							} else {
								if (anInt1830 != -1) {
									method978(this.aByteArrayArray1819[var7], var2 + this.anIntArray1822[var7] + 1,
											var3 + this.anIntArray1823[var7] + 1, var14, var10, anInt1830, anInt1835);
								}

								this.method988(this.aByteArrayArray1819[var7], var2 + this.anIntArray1822[var7],
										var3 + this.anIntArray1823[var7], var14, var10, anInt1834, anInt1835);
							}
						} else if (anInt1836 > 0) {
							anInt1837 += anInt1836;
							var2 += anInt1837 >> 8;
						...
						if (anInt1829 != -1) {
							method796(var2, var3 + (int) ((double) this.anInt1824 * 0.7D), var9, anInt1829);
						}

						if (anInt1818 != -1) {
							method796(var2, var3 + this.anInt1824 + 1, var9, anInt1818);
						}
			...
			if (var1.charAt(var9) != 0) {
				...
				if (var10 == 60) {
					...
					if (var6 == -1) {
						...
						int var19 = this.anIntArray1820[var10];
							...
							if (anInt1835 == 256) {
								if (anInt1830 != -1) {
									method977(this.aByteArrayArray1819[var10],
											var2 + this.anIntArray1822[var10] + 1 + var13,
											var3 + this.anIntArray1823[var10] + 1 + var15, var19, var12, anInt1830);
								}

								this.method989(this.aByteArrayArray1819[var10],
										var2 + this.anIntArray1822[var10] + var13,
										var3 + this.anIntArray1823[var10] + var15, var19, var12, anInt1834);
							} else {
								if (anInt1830 != -1) {
								...
								this.method988(this.aByteArrayArray1819[var10],
										var2 + this.anIntArray1822[var10] + var13,
										var3 + this.anIntArray1823[var10] + var15, var19, var12, anInt1834, anInt1835);
							}
						} else if (anInt1836 > 0) {
							anInt1837 += anInt1836;
							var2 += anInt1837 >> 8;
						...
						if (anInt1829 != -1) {
							method796(var2, var3 + (int) ((double) this.anInt1824 * 0.7D), var14, anInt1829);
						}

						if (anInt1818 != -1) {
							method796(var2, var3 + this.anInt1824, var14, anInt1818);
						}
	...
	static void method979(int[] var0, byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
		...
		for (int var10 = -var6; var10 < 0; ++var10) {
			for (int var12 = -var5; var12 < 0; ++var12) {
				if (var1[var3++] != 0) {
					int var11 = var0[var4];
					var0[var4++] = (((var11 & 16711935) * var9 & -16711936)
							+ ((var11 & '\uff00') * var9 & 16711680) >> 8) + var2;
				} else {
					++var4;
				}
			}
	...
	public int method990(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9,
		...
		if (var1 == null) {
			...
			int var13;
			if (var9 == 0) {
				var13 = var3 + this.anInt1825;
			} else if (var9 == 1) {
				var13 = var3 + this.anInt1825 + (var5 - this.anInt1825 - this.anInt1838 - (var12 - 1) * var10) / 2;
			} else if (var9 == 2) {
				...
				var13 = var3 + this.anInt1825 + var11;
				var10 += var11;
			}
			...
			for (var11 = 0; var11 < var12; ++var11) {
				if (var8 == 0) {
					...
					this.method975(aStringArray1839[var11], var2 + (var4 - this.method967(aStringArray1839[var11])) / 2,
							var13);
				} else if (var8 == 2) {
