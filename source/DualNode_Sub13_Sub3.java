...
public abstract class DualNode_Sub13_Sub3 extends RSGraphics {
         ...
         for(var141 = 0; var141 < 256; var141++) {
            if(var141 != 32 && var141 != 160) {
               for(var6 = 0; var6 < 256; var6++) {
                  if(var6 != 32 && var6 != 160) {
                     this.aByteArray1821[(var141 << 8) + var6] = (byte)method986(var10, var131, var9, this.anIntArray1826, var121, var141, var6);
                  }
               }
            }
         }
            ...
            if(var7 == 60) {
               ...
               if(var4 == -1) {
                  ...
                  if(var7 != 32) {
                     if(anInt1835 == 256) {
                        if(anInt1830 != -1) {
                           method977(this.aByteArrayArray1819[var7], this.anIntArray1822[var7] + var2 + 1, this.anIntArray1823[var7] + var3 + 1, var13, var10, anInt1830);
                        }

                        this.method989(this.aByteArrayArray1819[var7], this.anIntArray1822[var7] + var2, this.anIntArray1823[var7] + var3, var13, var10, anInt1834);
                     } else {
                        if(anInt1830 != -1) {
                           method978(this.aByteArrayArray1819[var7], this.anIntArray1822[var7] + var2 + 1, this.anIntArray1823[var7] + var3 + 1, var13, var10, anInt1830, anInt1835);
                        }

                        this.method988(this.aByteArrayArray1819[var7], this.anIntArray1822[var7] + var2, this.anIntArray1823[var7] + var3, var13, var10, anInt1834, anInt1835);
                     }
                  } else if(anInt1836 > 0) {
                     anInt1837 += anInt1836;
                     var2 += anInt1837 >> 8;
            ...
            if(var10 == 60) {
               ...
               if(var6 == -1) {
                  ...
                  if(var10 != 32) {
                     if(anInt1835 == 256) {
                        if(anInt1830 != -1) {
                           method977(this.aByteArrayArray1819[var10], this.anIntArray1822[var10] + var2 + 1 + var13, this.anIntArray1823[var10] + var3 + 1 + var15, var18, var12, anInt1830);
                        }

                        this.method989(this.aByteArrayArray1819[var10], this.anIntArray1822[var10] + var2 + var13, this.anIntArray1823[var10] + var3 + var15, var18, var12, anInt1834);
                     } else {
                        if(anInt1830 != -1) {
                           method978(this.aByteArrayArray1819[var10], this.anIntArray1822[var10] + var2 + 1 + var13, this.anIntArray1823[var10] + var3 + 1 + var15, var18, var12, anInt1830, anInt1835);
                        }

                        this.method988(this.aByteArrayArray1819[var10], this.anIntArray1822[var10] + var2 + var13, this.anIntArray1823[var10] + var3 + var15, var18, var12, anInt1834, anInt1835);
                     }
                  } else if(anInt1836 > 0) {
                     anInt1837 += anInt1836;
                     var2 += anInt1837 >> 8;
   ...
   static void method979(int[] var0, byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      ...
      for(int var10 = -var6; var10 < 0; var10++) {
         for(int var12 = -var5; var12 < 0; var12++) {
            if(var1[var3++] != 0) {
               int var11 = var0[var4];
               var0[var4++] = (((var11 & 0xff00ff) * var9 & 0xff00ff00) + ((var11 & 0xff00) * var9 & 0xff0000) >> 8) + var2;
            } else {
               ++var4;
            }
         }
   ...
   static void method987(int[] var0, byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 0x3);
   ...
   public int method990(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      if(var1 == null) {
         return 0;
      } else {
         ...
         for(var11 = 0; var11 < var12; var11++) {
            if(var8 == 0) {
               ...
               this.method975(aStringArray1839[var11], (var4 - this.method967(aStringArray1839[var11])) / 2 + var2, var13);
            } else if(var8 == 2) {
               this.method975(aStringArray1839[var11], var2 + var4 - this.method967(aStringArray1839[var11]), var13);
