...
public class IdentKitType extends DualNode {
   ...
   public Entity_Sub1 method660() {
      if(this.anIntArray1460 == null) {
         ...
         for(int var4 = 0; var4 < this.anIntArray1460.length; var4++) {
            var2[var4] = Entity_Sub1.method887(Class120.aClass87_805, this.anIntArray1460[var4], 0);
         }
         ...
         if(var2.length == 1) {
            ...
            var41 = new Entity_Sub1(var2, var2.length);
         }
   ...
   public Entity_Sub1 method663() {
      ...
      for(int var5 = 0; var5 < 5; var5++) {
         if(this.anIntArray1462[var5] != -1) {
            var1[var4++] = Entity_Sub1.method887(Class120.aClass87_805, this.anIntArray1462[var5], 0);
         }
      }

      Entity_Sub1 var51 = new Entity_Sub1(var1, var4);
      int var2;
      if(this.aShortArray1461 != null) {
   ...
   static final void decodeNpcFlags() {
      for(int index = 0; index < Client.pendingNpcFlagsCount; index++) {
         ...
         if((flags & 0x2) != 0) {
            ...
            } else if(var5 == -1 || npc.animation == -1 || Node_Sub6.getSequenceType(var5).anInt1480 >= Node_Sub6.getSequenceType(npc.animation).anInt1480) {
               npc.animation = var5;
               npc.anInt1934 = 0;
               npc.anInt1935 = 0;
               npc.anInt1936 = var4;
   ...
   static final void method668(int var0, int var1, int var2, int var3) {
      for(int var4 = 0; var4 < Client.anInt2168; var4++) {
         if(Client.anIntArray2175[var4] + Client.anIntArray2173[var4] > var0 && Client.anIntArray2173[var4] < var0 + var2 && Client.anIntArray2176[var4] + Client.anIntArray2174[var4] > var1 && Client.anIntArray2174[var4] < var1 + var3) {
