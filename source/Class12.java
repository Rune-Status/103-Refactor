public class Class12 {
   ...
   int method109() {
      int var1;
      for(var1 = 0; this.anIntArray223[var1] >= 0; var1 = Node_Sub3.method515() != 0 ? this.anIntArray223[var1] : var1 + 1) {
         ;
      }
   ...
   Class12() {
      ...
      if(var3) {
         ...
         for(var5 = Node_Sub3.method517(5) + 1; var7 < this.anInt220; var5++) {
            int var14 = Node_Sub3.method517(DualNode_Sub8.method709(this.anInt220 - var7));
      ...
      if(var7 > 0) {
         float var161 = Node_Sub3.method524(Node_Sub3.method517(32));
         ...
         if(var7 == 1) {
            ...
            for(var1 = 0; var1 < this.anInt220; var1++) {
               var4 = 0.0F;
               var2 = this.anInt224 * var1;

               for(var13 = 0; var13 < this.anInt224; var13++) {
                  float var171 = (float)this.anIntArray222[var2] * var17 + var161 + var4;
                  this.aFloatArrayArray219[var1][var13] = var171;
                  if(var6) {
                     var4 = var171;
                  }
