public class Node_Sub4_Sub2 extends Node_Sub4 {
      ...
      if(this.anInt1566 < 0) {
         if(!this.aBool1555) {
            if(this.anInt1554 < 0) {
               ...
               this.anInt1557 = (this.anInt1557 - var4) % var6 + var4;
            }
         } else {
            if(this.anInt1554 < 0) {
               if(this.anInt1557 >= var4) {
               ...
               label149: {
                  ...
                  if(this.anInt1554 < 0) {
                     ...
                     if(var3 >= this.anInt1566) {
                        this.anInt1557 += this.anInt1566 * var6;
                        this.anInt1566 = 0;
                        break label149;
                     }
   ...
   public static Node_Sub4_Sub2 method737(Node_Sub2_Sub1 var0, int var1, int var2, int var3) {
      return var0.aByteArray1543 != null && var0.aByteArray1543.length != 0 ? new Node_Sub4_Sub2(var0, var1, var2, var3) : null;
   }
   ...
   static int method738(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, Node_Sub4_Sub2 var10) {
      var3 >>= 8;
      var9 >>= 8;
      var5 <<= 2;
      var6 <<= 2;
   ...
   public boolean method750() {
      return this.anInt1557 < 0 || this.anInt1557 >= ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543.length << 8;
   }
   ...
   int method753(int[] var1, int var2, int var3, int var4, int var5) {
      while(true) {
         if(this.anInt1563 > 0) {
            ...
            if(this.anInt1554 == 256 && (this.anInt1557 & 0xff) == 0) {
               if(AbstractSoundSystem.highMemory) {
                  var2 = method759(0, ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1558, this.anInt1559, this.anInt1564, this.anInt1567, 0, var6, var3, this);
               } else {
                  var2 = method758(((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1560, this.anInt1565, 0, var6, var3, this);
               }
            } else if(AbstractSoundSystem.highMemory) {
               var2 = method762(0, 0, ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1558, this.anInt1559, this.anInt1564, this.anInt1567, 0, var6, var3, this, this.anInt1554, var5);
            } else {
               var2 = method761(0, 0, ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1560, this.anInt1565, 0, var6, var3, this, this.anInt1554, var5);
            }
         ...
         if(this.anInt1554 == 256 && (this.anInt1557 & 0xff) == 0) {
            if(AbstractSoundSystem.highMemory) {
               return method738(0, ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1558, this.anInt1559, 0, var4, var3, this);
            }

            return method756(((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1560, 0, var4, var3, this);
         }

         if(AbstractSoundSystem.highMemory) {
            return method767(0, 0, ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1558, this.anInt1559, 0, var4, var3, this, this.anInt1554, var5);
         }

         return method757(0, 0, ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1560, 0, var4, var3, this, this.anInt1554, var5);
      }
   }
   ...
   int method754(int[] var1, int var2, int var3, int var4, int var5) {
      while(true) {
         if(this.anInt1563 > 0) {
            ...
            if(this.anInt1554 == -256 && (this.anInt1557 & 0xff) == 0) {
               if(AbstractSoundSystem.highMemory) {
                  var2 = method770(0, ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1558, this.anInt1559, this.anInt1564, this.anInt1567, 0, var6, var3, this);
               } else {
                  var2 = method760(((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1560, this.anInt1565, 0, var6, var3, this);
               }
            } else if(AbstractSoundSystem.highMemory) {
               var2 = method764(0, 0, ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1558, this.anInt1559, this.anInt1564, this.anInt1567, 0, var6, var3, this, this.anInt1554, var5);
            } else {
               var2 = method763(0, 0, ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1560, this.anInt1565, 0, var6, var3, this, this.anInt1554, var5);
            }
         ...
         if(this.anInt1554 == -256 && (this.anInt1557 & 0xff) == 0) {
            if(AbstractSoundSystem.highMemory) {
               return method775(0, ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1558, this.anInt1559, 0, var4, var3, this);
            }

            return method773(((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1560, 0, var4, var3, this);
         }

         if(AbstractSoundSystem.highMemory) {
            return method774(0, 0, ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1558, this.anInt1559, 0, var4, var3, this, this.anInt1554, var5);
         }

         return method766(0, 0, ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543, var1, this.anInt1557, var2, this.anInt1560, 0, var4, var3, this, this.anInt1554, var5);
      }
   }
   ...
   static int method756(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, Node_Sub4_Sub2 var8) {
      var2 >>= 8;
      var7 >>= 8;
      var4 <<= 2;
   ...
   static int method757(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, Node_Sub4_Sub2 var10, int var11, int var12) {
   ...
   static int method758(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, Node_Sub4_Sub2 var9) {
      var2 >>= 8;
      var8 >>= 8;
      var4 <<= 2;
      var5 <<= 2;
   ...
   static int method759(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, Node_Sub4_Sub2 var12) {
      var3 >>= 8;
      var11 >>= 8;
      var5 <<= 2;
      var6 <<= 2;
   ...
   static int method760(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, Node_Sub4_Sub2 var9) {
      var2 >>= 8;
      var8 >>= 8;
      var4 <<= 2;
      var5 <<= 2;
   ...
   static int method761(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, Node_Sub4_Sub2 var11, int var12, int var13) {
   ...
   static int method762(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, Node_Sub4_Sub2 var13, int var14, int var15) {
   ...
   static int method763(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, Node_Sub4_Sub2 var11, int var12, int var13) {
      var11.anInt1558 -= var11.anInt1564 * var5;
      var11.anInt1559 -= var11.anInt1567 * var5;
   ...
   static int method764(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, Node_Sub4_Sub2 var13, int var14, int var15) {
      var13.anInt1560 -= var13.anInt1565 * var5;
   ...
   static int method766(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, Node_Sub4_Sub2 var10, int var11, int var12) {
   ...
   static int method767(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, Node_Sub4_Sub2 var11, int var12, int var13) {
      if(var12 == 0 || (var8 = (var10 - var4 + var12 - 257) / var12 + var5) > var9) {
         var8 = var9;
      }
   ...
   static int method770(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, Node_Sub4_Sub2 var12) {
      var3 >>= 8;
      var11 >>= 8;
      var5 <<= 2;
      var6 <<= 2;
   ...
   int method525() {
      ...
      if(this.anInt1566 == 0) {
         var1 -= this.anInt1557 * var1 / (((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543.length << 8);
      } else if(this.anInt1566 >= 0) {
         var1 -= this.anInt1562 * var1 / ((Node_Sub2_Sub1)this.aNode_Sub2_1258).aByteArray1543.length;
      }
   ...
   public static Node_Sub4_Sub2 method771(Node_Sub2_Sub1 var0, int var1, int var2) {
      return var0.aByteArray1543 != null && var0.aByteArray1543.length != 0 ? new Node_Sub4_Sub2(var0, (int)((long)var0.anInt1542 * 256L * (long)var1 / (long)(AbstractSoundSystem.sampleRate * 100)), var2 << 6) : null;
   }
   ...
   static int method773(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, Node_Sub4_Sub2 var8) {
      var2 >>= 8;
      var7 >>= 8;
      var4 <<= 2;
   ...
   static int method774(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, Node_Sub4_Sub2 var11, int var12, int var13) {
      if(var12 == 0 || (var8 = (var10 + 256 - var4 + var12) / var12 + var5) > var9) {
         var8 = var9;
      }
      ...
      if(this.anInt1561 == 0 && this.anInt1563 == 0) {
         ...
         if(this.anInt1566 < 0) {
            ...
            while(true) {
               ...
               this.anInt1557 = (this.anInt1557 - var7) % var8 + var7;
            }
         }
               ...
               if(this.anInt1554 < 0) {
                  while(true) {
                     ...
                     if(var10 >= this.anInt1566) {
                        this.anInt1557 += this.anInt1566 * var8;
                        this.anInt1566 = 0;
                        break;
                     }
   ...
   static int method775(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, Node_Sub4_Sub2 var10) {
      var3 >>= 8;
      var9 >>= 8;
      var5 <<= 2;
      var6 <<= 2;
