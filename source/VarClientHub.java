...
public class VarClientHub {
		...
		for (int var4 = var1; var4 <= var3 + var1; var4++) {
			for (int var5 = var0; var5 <= var2 + var0; var5++) {
				if (var5 >= 0 && var5 < 104 && var4 >= 0 && var4 < 104) {
					Scene.shadowMap[0][var5][var4] = 127;
					if (var5 == var0 && var5 > 0) {
						Scene.tileHeights[0][var5][var4] = Scene.tileHeights[0][var5 - 1][var4];
					}
					...
					if (var1 == var4 && var4 > 0) {
						Scene.tileHeights[0][var5][var4] = Scene.tileHeights[0][var5][var4 - 1];
					}
	...
	static void method183(Widget var0, int var1, int var2, boolean var3) {
		...
		if (var3 && var0.anObjectArray1188 != null && (var0.width != var4 || var0.height * 1227800423 != var6)) {
			...
			Client.aDeque2164.addFront(var5);
		}
		...
		for (Projectile var0 = (Projectile) Client.projectileDeque
			...
			if (var0.anInt1844 == InterfaceNode.floorLevel * -1331355705 && Client.engineCycle <= var0.loopCycle) {
				if (Client.engineCycle >= var0.anInt1846) {
					...
					InterfaceNode.landscape.method19(InterfaceNode.floorLevel * -1331355705, (int) var0.aDouble1848,
							(int) var0.aDouble1849, (int) var0.aDouble1843, 60, var0, var0.anInt1850, -1, false);
				}
			} else {
				var0.unlink();
			}
